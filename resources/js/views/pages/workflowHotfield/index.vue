...
export default {
  ...
  watch: {
    ...
    isCheckAll(after, befour) {
      if (after) {
        this.roleWorkflowHotfields.forEach((el) => {
  ...
  methods: {
      ...
      if (Array.isArray(id)) {
        Swal.fire({
          ...
          if (result.value) {
            this.isLoader = true;
            adminApi
              .post(`/role-screen-hotfield/bulk-delete`, { ids: id })
              .then((res) => {
                this.checkAll = [];
                this.getData();
                Swal.fire({
        ...
        Swal.fire({
          ...
          if (result.value) {
            ...
            adminApi
              .delete(`/role-screen-hotfield/${id}`)
              .then((res) => {
                this.checkAll = [];
                this.getData();
                Swal.fire({
    ...
    AddSubmit() {
      ...
      if (this.$v.create.$invalid) {
        ...
        this.errors = {};
        adminApi
          .post(`/role-screen-hotfield`, this.create)
          .then((res) => {
    ...
    editSubmit(id) {
      ...
      if (this.$v.edit.$invalid) {
        ...
        adminApi
          .post(`/role-screen-hotfield/${id}`, this.edit)
          .then((res) => {
    ...
    log(id) {
      if (this.mouseEnter != id) {
        ...
        this.mouseEnter = id;
        adminApi
          .get(`/role-screen-hotfield/logs/${id}`)
          .then((res) => {
            let l = res.data.data;
            l.forEach((e) => {
        ...
        <div class="card">
          <div class="card-body">
            ...
            <div class="row justify-content-between align-items-center mb-2">
              <h4 class="header-title">{{ $t("general.roleWorkflowHotfieldsTable") }}</h4>
                ...
                <div class="d-fex">
                  ...
                  <div class="d-inline-flex align-items-center pagination-custom">
                    <div class="d-inline-block" style="font-size: 13px">
                      {{ roleWorkflowHotfieldsPagination.from }}-{{
                        roleWorkflowHotfieldsPagination.to
                      }}
                      /
                      {{ roleWorkflowHotfieldsPagination.total }}
                    </div>
                    <div class="d-inline-block">
                      <a
                        ...
                        :style="{
                          'pointer-events':
                            roleWorkflowHotfieldsPagination.current_page == 1
                              ? 'none'
                              : '',
                        }"
                        @click.prevent="
                          getData(roleWorkflowHotfieldsPagination.current_page - 1)
                        "
                      >
                        <span>&lt;</span>
                      </a>
                      ...
                      <a
                        ...
                        :style="{
                          'pointer-events':
                            roleWorkflowHotfieldsPagination.last_page ==
                            roleWorkflowHotfieldsPagination.current_page
                              ? 'none'
                              : '',
                        }"
                        @click.prevent="
              ...
              <table class="table table-borderless table-hover table-centered m-0">
                ...
                <tbody v-if="roleWorkflowHotfields.length > 0">
                  <tr
                    ...
                    v-for="(data, index) in roleWorkflowHotfields"
                    :key="data.id"
