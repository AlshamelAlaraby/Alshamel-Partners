...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  methods: {
    ...
    getData: function getData() {
      ...
      this.isLoader = true;
      _api_adminAxios__WEBPACK_IMPORTED_MODULE_2__["default"].get("/financial-years?page=".concat(page, "&per_page=").concat(this.per_page, "&search=").concat(this.search)).then(function (res) {
        var l = res.data;
    ...
    getDataCurrentPage: function getDataCurrentPage() {
      ...
      if (this.current_page <= this.financialYearsPagination.last_page && this.current_page != this.financialYearsPagination.current_page && this.current_page) {
        this.isLoader = true;
        _api_adminAxios__WEBPACK_IMPORTED_MODULE_2__["default"].get("/financial-years?page=".concat(this.current_page, "&per_page=").concat(this.per_page, "&search=").concat(this.search)).then(function (res) {
          var l = res.data;
     ...
     */
    deleteFinancialYear: function deleteFinancialYear(id) {
      var _this5 = this;
      sweetalert2__WEBPACK_IMPORTED_MODULE_4___default().fire({
