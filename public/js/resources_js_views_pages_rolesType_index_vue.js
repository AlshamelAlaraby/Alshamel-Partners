...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  methods: {
    ...
    getData: function getData() {
      ...
      this.isLoader = true;
      _api_adminAxios__WEBPACK_IMPORTED_MODULE_2__["default"].get("/role_types?page=".concat(page, "&per_page=").concat(this.per_page, "&search=").concat(this.search)).then(function (res) {
        var l = res.data;
    ...
    getDataCurrentPage: function getDataCurrentPage() {
      ...
      if (this.current_page <= this.rolesTypePagination.last_page && this.current_page != this.rolesTypePagination.current_page && this.current_page) {
        this.isLoader = true;
        _api_adminAxios__WEBPACK_IMPORTED_MODULE_2__["default"].get("/role_types?page=".concat(this.current_page, "&per_page=").concat(this.per_page, "&search=").concat(this.search)).then(function (res) {
          var l = res.data;
    ...
    AddSubmit: function AddSubmit() {
      ...
      if (this.$v.create.$invalid) {
        ...
        this.isLoader = true;
        this.errors = {};
        _api_adminAxios__WEBPACK_IMPORTED_MODULE_2__["default"].post("/role_types", this.create).then(function (res) {
...
var render = function render() {
  ...
  })])])]), _vm._v(" "), _vm.rolesType.length > 0 ? _c("tbody", _vm._l(_vm.rolesType, function (data, index) {
    return _c("tr", {
      key: data.id,
