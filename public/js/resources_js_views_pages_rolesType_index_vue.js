...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  methods: {
    ...
    getData: function getData() {
      ...
      this.isLoader = true;
      _api_adminAxios__WEBPACK_IMPORTED_MODULE_2__["default"].get("/role_types?page=".concat(page, "&per_page=").concat(this.per_page)).then(function (res) {
        var l = res.data;
    ...
    getDataCurrentPage: function getDataCurrentPage() {
      ...
      if (this.current_page <= this.rolesTypePagination.last_page && this.current_page != this.rolesTypePagination.current_page && this.current_page) {
        this.isLoader = true;
        _api_adminAxios__WEBPACK_IMPORTED_MODULE_2__["default"].get("/role_types?page=".concat(page, "&per_page=").concat(this.per_page, "&search=").concat(this.search, "&columns=").concat(this.filterSetting)).then(function (res) {
          var l = res.data;
