...
export default {
    ...
    methods: {
        ...
        getData(page = 1) {
            ...
            adminApi.get(`/colors?page=${page}&per_page=${this.per_page}&search=${this.search}`)
                .then((res) => {
                    let l = res.data;
                    this.colors = l.data;
                    this.colorsPagination = l.pagination;
        ...
        getDataCurrentPage() {
            if (this.current_page <= this.colorsPagination.last_page && this.current_page != this.colorsPagination.current_page && this.current_page) {
                ...
                adminApi.get(`/colors?page=${this.current_page}&per_page=${this.per_page}&search=${this.search}`)
                    .then((res) => {
                        let l = res.data;
                        this.colors = l.data;
                        this.colorsPagination = l.pagination;
        ...
        AddSubmit() {
            ...
            if (this.$v.create.$invalid) {
                ...
                this.isLoader = true;
                this.errors = {};
                adminApi.post(`/colors`, this.create)
                    .then((res) => {
                        this.$bvModal.hide(`create`);
                        this.getData();
                        setTimeout(() => {
        ...
        editSubmit(id) {
            ...
            if (this.$v.edit.$invalid) {
                ...
                adminApi.put(`/colors/${id}`, {name, name_e, is_active})
                    .then((res) => {
         ...
         */
        resetModalEdit(id) {
            let module = this.colors.find(e => id == e.id);
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="row justify-content-between align-items-center mb-2">
                            <h4 class="header-title"> {{ $t('colors.Table') }}</h4>
                            <div class="col-xs-10 col-md-9 col-lg-7" style="font-weight: 500">
                                ...
                                <div class="d-inline-block" style="width: 22.2%;">
                                    ...
                                    <b-dropdown variant="primary" :text="$t('general.searchSetting')" ref="dropdown"
                                        ...
                                        <b-form-checkbox v-model="setting" value="is_active" class="mb-1">
                                            {{ $t('general.Status') }}
                                        </b-form-checkbox>
                                    </b-dropdown>
                                    <!-- Basic dropdown -->
                                ...
                                <div class="d-fex">
                                    ...
                                    <div class="d-inline-flex align-items-center pagination-custom">
                                        <div class="d-inline-block" style="font-size:13px;">
                                            {{ colorsPagination.from }}-{{ colorsPagination.to }} /
                                            {{ colorsPagination.total }}
                                        </div>
                                        <div class="d-inline-block">
                                            <a
                                                href="javascript:void(0)"
                                                :style="{'pointer-events':colorsPagination.current_page == 1 ? 'none': ''}"
                                                @click.prevent="getData(colorsPagination.current_page - 1)"
                                            >
                                                <span>&lt;</span>
                                            </a>
                                            <input
                                            ...
                                            <a
                                                href="javascript:void(0)"
                                                :style="{'pointer-events':colorsPagination.last_page == colorsPagination.current_page ? 'none': ''}"
                                                @click.prevent="getData(colorsPagination.current_page + 1)"
                                            >
                                                <span>&gt;</span>
                                            </a>
