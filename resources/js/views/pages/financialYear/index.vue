...
export default {
    ...
    methods: {
        ...
        getData(page = 1){
            ...
            adminApi.get(`/financial-years?page=${page}&per_page=${this.per_page}`)
                .then((res) => {
                    let l = res.data;
        ...
        getDataCurrentPage(page =1){
            if(this.current_page <= this.financialYearsPagination.last_page && this.current_page != this.financialYearsPagination.current_page && this.current_page){
                ...
                adminApi.get(`/financial-years?page=${page}&per_page=${this.per_page}&search=${this.search}&=columns${this.filterSetting}`)
                    .then((res) => {
                        let l = res.data;
                        this.financialYears = l.data;
                        this.financialYearsPagination = l.pagination;
