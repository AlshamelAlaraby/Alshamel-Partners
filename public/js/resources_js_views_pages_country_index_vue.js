    ...
    AddSubmit: function AddSubmit() {
      ...
      if (this.$v.create.$invalid) {
        ...
        _api_adminAxios__WEBPACK_IMPORTED_MODULE_2__["default"].post("/countries", this.create).then(function (res) {
          _this9.country_id = res.data.data.id;
          setTimeout(function () {
            sweetalert2__WEBPACK_IMPORTED_MODULE_4___default().fire({
              icon: 'success',
    ...
    addImage: function addImage(file) {
      ...
      if (file) {
        ...
        _api_adminAxios__WEBPACK_IMPORTED_MODULE_2__["default"].post("/media", formDate).then(function (res) {
          console.log(res.data.data);
          _api_adminAxios__WEBPACK_IMPORTED_MODULE_2__["default"].put("/countries/".concat(_this12.country_id)).then(function (res) {
            console.log(res.data.data);
            _this12.saveImageName.push(file.name);
            //preview of image
            var reader = new FileReader();
            reader.onload = function (e) {
              _this12.images.push("".concat(e.target.result));
              _this12.showPhoto = "".concat(e.target.result);
            };
