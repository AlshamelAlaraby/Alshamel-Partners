  ...
  methods: {
    ...
    AddSubmit: function AddSubmit() {
      ...
      if (this.$v.create.$invalid) {
        ...
        this.isLoader = true;
        this.errors = {};
        _api_adminAxios__WEBPACK_IMPORTED_MODULE_2__["default"].post("/payment-types", this.create).then(function (res) {
...
var render = function render() {
  ...
  return _c("Layout", [_c("PageHeader"), _vm._v(" "), _c("div", {
    ...
    attrs: {
      id: "create",
      title: _vm.$t("general.AddPaymentType"),
      "title-class": "font-18",
      "body-class": "p-4 ",
      "hide-footer": true
    },
    ...
    staticClass: "d-flex justify-content-center"
  }, [_c("span", [_vm._v(_vm._s(_vm.$t("general.is_default")))]), _vm._v(" "), _c("div", {
    staticClass: "arrow-sort"
  }, [_c("i", {
    staticClass: "fas fa-arrow-up",
    on: {
  ...
  })])])]), _vm._v(" "), _vm.paymentTypes.length > 0 ? _c("tbody", _vm._l(_vm.paymentTypes, function (data, index) {
    return _c("tr", {
      key: data.id,
      ...
      attrs: {
        ...
        title: _vm.$t("general.EditPaymentType"),
        "title-class": "font-18",
        "body-class": "p-4",
        "hide-footer": true
      },
