...
export default {
  ...
  methods: {
     ...
     */
    resetModalHidden() {
      this.create = { name: "", name_e: "", parent_id: ""};
      this.$nextTick(() => {
        this.$v.$reset();
      });
      this.errors = {};
    ...
    editSubmit(id) {
      ...
      if (this.$v.edit.$invalid) {
        ...
        this.isLoader = true;
        this.errors = {};
        let { name, name_e, parent_id } = this.edit;
        adminApi
      ...
      <div class="col-12">
        <div class="card">
          <div class="card-body">
                ...
                <div>
                  ...
                  >
                    ...
                    <b-form-checkbox v-model="setting.parent_id" class="mb-1">
                      {{ $t("general.ArchDepartmentParentID") }}
                    </b-form-checkbox>
            ...
            <b-modal
              id="create"
              :title="$t('ArchDepartment.AddArchDepartment')"
              title-class="font-18"
              body-class="p-4 "
              :hide-footer="true"
              size="lg"
                ...
                <thead>
                  <tr>
                    ...
                    <th v-if="setting.parent_id">
                      <div class="d-flex justify-content-center">
                        <span>{{ $t("general.ArchDepartmentParentID") }}</span>
                        <div class="arrow-sort">
                          <i
                            class="fas fa-arrow-up"
