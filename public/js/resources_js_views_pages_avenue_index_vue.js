  ...
  methods: {
    ...
    AddSubmit: function AddSubmit() {
      ...
      if (this.$v.create.$invalid) {
        ...
        this.isLoader = true;
        this.errors = {};
        _api_adminAxios__WEBPACK_IMPORTED_MODULE_2__["default"].post("/avenues", this.create).then(function (res) {
    ...
    resetModalEdit: function resetModalEdit(id) {
      var city = this.avenues.find(function (e) {
        return id == e.id;
      });
    ...
    searchSenderGovernorate: function searchSenderGovernorate(e) {
      this.dropDownSenders = [];
      this.create.parent_id = 0;
      this.edit.parent_id = 0;
      if (this.create.search || this.edit.search) {
    ...
    showSenderGovernorate: function showSenderGovernorate(index) {
      var item = this.dropDownSenders[index];
      this.create.parent_id = item.id;
      this.create.search = this.$i18n.locale == 'ar' ? item.name : item.name_e;
      this.edit.parent_id = item.id;
    ...
    searchSenderCity: function searchSenderCity(e) {
      this.dropDownSenders = [];
      this.create.parent_id = 0;
      this.edit.parent_id = 0;
      if (this.create.search || this.edit.search) {
    ...
    showSenderCity: function showSenderCity(index) {
      var item = this.dropDownSenders[index];
      this.create.parent_id = item.id;
      this.create.search = this.$i18n.locale == 'ar' ? item.name : item.name_e;
      this.edit.parent_id = item.id;
...
var render = function render() {
  ...
  return _c("Layout", [_c("PageHeader"), _vm._v(" "), _c("div", {
  ...
  }, [_vm._v(" " + _vm._s(_vm.$t("avenue.avenuesTable")))]), _vm._v(" "), _c("div", {
  ...
  }, [_vm._v("\n                                        " + _vm._s(_vm.avenuesPagination.from) + "-" + _vm._s(_vm.avenuesPagination.to) + " / " + _vm._s(_vm.avenuesPagination.total) + "\n                                    ")]), _vm._v(" "), _c("div", {
    staticClass: "d-inline-block"
  }, [_c("a", {
    style: {
    ...
    staticClass: "form-control input-Sender",
    "class": {
      "is-invalid": _vm.$v.create.governorate_id.$error || _vm.errors.governorate_id,
      "is-valid": !_vm.$v.create.governorate_id.$invalid && !_vm.errors.governorate_id
    },
    attrs: {
      type: "text",
      "data-create": "4",
    ...
    return _c("li", {
      ...
      on: {
        click: function click($event) {
          return _vm.showSenderGovernorate(index);
        },
        mouseenter: _vm.senderHover
      }
    }, [_vm._v("\n                                                " + _vm._s("".concat(dropDownSender.id, "- ").concat(dropDownSender.name)) + "\n                                            ")]);
  }), 0) : _vm._e(), _vm._v(" "), _vm.errors.governorate_id ? _vm._l(_vm.errors.governorate_id, function (errorMessage, index) {
    return _c("ErrorMessage", {
      key: index
    }, [_vm._v(_vm._s(errorMessage))]);
  }) : _vm._e()], 2)]), _vm._v(" "), _c("div", {
    ...
    staticClass: "form-control input-Sender",
    "class": {
      "is-invalid": _vm.$v.create.city_id.$error || _vm.errors.city_id,
      "is-valid": !_vm.$v.create.city_id.$invalid && !_vm.errors.city_id
    },
    attrs: {
      type: "text",
      "data-create": "5",
  ...
  }), 0) : _vm._e(), _vm._v(" "), _vm.errors.city_id ? _vm._l(_vm.errors.city_id, function (errorMessage, index) {
    return _c("ErrorMessage", {
      key: index
    }, [_vm._v(_vm._s(errorMessage))]);
  }) : _vm._e()], 2)]), _vm._v(" "), _c("div", {
    ...
    staticClass: "d-flex justify-content-center"
  }, [_c("span", [_vm._v(_vm._s(_vm.$t("general.city")))]), _vm._v(" "), _c("div", {
    staticClass: "arrow-sort"
  }, [_c("i", {
    staticClass: "fas fa-arrow-up",
    on: {
  ...
  })])])]), _vm._v(" "), _c("th", [_vm._v(_vm._s(_vm.$t("general.Action")))]), _vm._v(" "), _c("th", [_c("i", {
    staticClass: "fas fa-ellipsis-v"
  })])])]), _vm._v(" "), _vm.avenues.length > 0 ? _c("tbody", _vm._l(_vm.avenues, function (data, index) {
    return _c("tr", {
      key: data.id,
      ...
      staticClass: "m-0 font-weight-normal"
    }, [_vm._v(_vm._s(data.name_e))])]), _vm._v(" "), _c("td", [_vm._v(_vm._s(data.country_id))]), _vm._v(" "), _c("td", [_vm._v(_vm._s(data.governorate_id))]), _vm._v(" "), _c("td", [_vm._v(_vm._s(data.city_id))]), _vm._v(" "), _c("td", [_c("span", {
      ...
      staticClass: "form-control input-Sender",
      "class": {
        "is-invalid": _vm.$v.edit.governorate_id.$error || _vm.errors.governorate_id,
        "is-valid": !_vm.$v.edit.governorate_id.$invalid && !_vm.errors.governorate_id
      },
      attrs: {
        type: "text",
        "data-edit": "4",
      ...
      staticClass: "form-control input-Sender",
      "class": {
        "is-invalid": _vm.$v.edit.city_id.$error || _vm.errors.city_id,
        "is-valid": !_vm.$v.edit.city_id.$invalid && !_vm.errors.city_id
      },
      attrs: {
        type: "text",
        "data-create": "5",
      ...
      on: {
        keypress: function keypress($event) {
          if (!$event.type.indexOf("key") && _vm._k($event.keyCode, "enter", 13, $event.key, "Enter")) return null;
          return _vm.moveInput("select", "edit", 6);
        },
        input: [function ($event) {
          if ($event.target.composing) return;
          _vm.$set(_vm.create, "search", $event.target.value.trim());
