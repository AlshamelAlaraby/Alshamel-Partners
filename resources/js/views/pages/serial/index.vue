...
export default {
    ...
    methods: {
        ...
        getData(page = 1){
            ...
            adminApi.get(`/serials?page=${page}&per_page=${this.per_page}&company_id=${this.company_id}`)
                .then((res) => {
                    let l = res.data;
                    this.serials = l.data;
        ...
        getDataCurrentPage(page = 1){
            if(this.current_page <= this.serialsPagination.last_page && this.current_page != this.serialsPagination.current_page && this.current_page){
                ...
                adminApi.get(`/serials?page=${page}&per_page=${this.per_page}&search=${this.search}&columns=${this.filterSetting}&company_id=${this.company_id}`)
                    .then((res) => {
                        let l = res.data;
                        this.serials = l.data;
                        this.serialsPagination = l.pagination;
        ...
        AddSubmit(){
            ...
            if (this.$v.create.$invalid) {
                ...
                this.isLoader = true;
                this.errors = {};
                adminApi.post(`/serials`,this.create)
                    .then((res) => {
                        this.$bvModal.hide(`create`);
                        this.getData();
                        setTimeout(() => {
        ...
        editSubmit(id){
            ...
            if (this.$v.edit.$invalid) {
                ...
                this.isLoader = true;
                this.errors = {};
                adminApi.put(`/serials/${id}`,{name,name_e})
                    .then((res) => {
        ...
        async resetModalEdit(id){
            ...
            this.edit.branch_id = branch.store_id;
            this.errors = {};
        },
        /**
         *  hidden Modal (edit)
        ...
        async getStore(id){
            ...
            await adminApi.get(`/stores?company_id=${this.company_id}&branch_id=${id}`)
                .then((res) => {
                    let l = res.data;
                    this.stores = l.data;
                })
                                ...
                                <div class="d-fex">
                                    ...
                                    <div class="d-inline-flex align-items-center pagination-custom">
                                        <div class="d-inline-block" style="font-size:13px;">
                                            {{ serialsPagination.from }}-{{ serialsPagination.to }} / {{ serialsPagination.total }}
                                        </div>
                                        <div class="d-inline-block">
                                            <a
                                                href="javascript:void(0)"
                                                :style="{'pointer-events':serialsPagination.current_page == 1 ? 'none': ''}"
                                            ...
                                            <a
                                                href="javascript:void(0)"
                                                :style="{'pointer-events':serialsPagination.last_page == serialsPagination.current_page ? 'none': ''}"
                                                @click.prevent="getData(serialsPagination.current_page + 1)"
                                            >
                                                <span>&gt;</span>
                                            </a>
                                    ...
                                    <th>
                                        <div class="d-flex justify-content-center">
                                            ...
                                            <div class="arrow-sort">
                                                <i class="fas fa-arrow-up" @click="serials.sort(sortString('name'))"></i>
                                                <i class="fas fa-arrow-down" @click="serials.sort(sortString('-name'))"></i>
                                            </div>
                                        </div>
                                    </th>
                                    <th>
                                        <div class="d-flex justify-content-center">
                                            ...
                                            <div class="arrow-sort">
                                                <i class="fas fa-arrow-up" @click="serials.sort(sortString('name_e'))"></i>
                                                <i class="fas fa-arrow-down" @click="serials.sort(sortString('-name_e'))"></i>
                                            </div>
                                        </div>
                                    </th>
                                    <th>
