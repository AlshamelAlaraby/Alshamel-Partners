...
export default {
  ...
  methods: {
    ...
    getDataCurrentPage(page = 1) {
      if (
        this.current_page <= this.branchesPagination.last_page &&
        this.current_page != this.branchesPagination.current_page &&
        this.current_page
      ) {
        this.isLoader = true;
        let filter = "";
                ...
                <div class="d-fex">
                  ...
                  <div class="d-inline-flex align-items-center pagination-custom">
                    <div class="d-inline-block" style="font-size: 13px">
                      {{ branchesPagination.from }}-{{ branchesPagination.to }} /
                    ...
                    <div class="d-inline-block">
                      <a
                        ...
                        :style="{
                          'pointer-events':
                            branchesPagination.current_page == 1 ? 'none' : '',
                        }"
                      ...
                      <a
                        ...
                        :style="{
                          'pointer-events':
                            branchesPagination.last_page ==
                            branchesPagination.current_page
                              ? 'none'
                              : '',
                        }"
                        @click.prevent="getData(branchesPagination.current_page + 1)"
