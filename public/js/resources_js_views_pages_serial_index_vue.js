  ...
  validations: {
    create: {
      start_no: {
        ...
        maxLength: (0,vuelidate_lib_validators__WEBPACK_IMPORTED_MODULE_13__.maxLength)(20)
      },
      suffix: {
        required: vuelidate_lib_validators__WEBPACK_IMPORTED_MODULE_13__.required,
        ...
        return _regeneratorRuntime().wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                _context.next = 2;
                return _this12.getBranch(_this12.company_id);
              case 2:
                serial = _this12.serials.find(function (e) {
                  return id == e.id;
                });
                _this12.edit.start_no = serial.start_no;
                _this12.edit.perfix = serial.perfix;
                _this12.edit.suffix = serial.suffix;
                _this12.edit.restart_period = serial.restart_period;
                _this12.edit.branch_id = serial.branch_id;
                _this12.edit.is_default = serial.is_default;
                _context.next = 11;
                return _this12.getStore(_this12.edit.branch_id);
              case 11:
                _this12.edit.store_id = serial.store_id;
                _this12.errors = {};
              case 13:
              case "end":
                return _context.stop();
            ...
            switch (_context2.prev = _context2.next) {
              case 0:
                ...
                return _api_adminAxios__WEBPACK_IMPORTED_MODULE_2__["default"].get("/branches?company_id=".concat(_this13.company_id)).then(function (res) {
                  var l = res.data;
                  _this13.branches = l.data;
                  _this13.create.branch_id = null;
                  _this13.edit.branch_id = null;
            ...
            switch (_context3.prev = _context3.next) {
              case 0:
                ...
                return _api_adminAxios__WEBPACK_IMPORTED_MODULE_2__["default"].get("/stores?branch_id=".concat(id)).then(function (res) {
                  var l = res.data;
                  _this14.stores = l.data;
                  _this14.create.store_id = null;
                  _this14.edit.store_id = null;
                })["catch"](function (err) {
                  sweetalert2__WEBPACK_IMPORTED_MODULE_4___default().fire({
                    icon: "error",
