...
export default {
    ...
    methods: {
        ...
        getData(page = 1) {
            ...
            adminApi.get(`/units?page=${page}&per_page=${this.per_page}&search=${this.search}`)
                .then((res) => {
                    let l = res.data;
                    this.units = l.data;
        ...
        getDataCurrentPage() {
            if (this.current_page <= this.unitsPagination.last_page && this.current_page != this.unitsPagination.current_page && this.current_page) {
                ...
                adminApi.get(`/units?page=${this.current_page}&per_page=${this.per_page}&search=${this.search}`)
                    .then((res) => {
                        let l = res.data;
                        this.units = l.data;
                        this.unitsPagination = l.pagination;
