...
var render = function render() {
  ...
  }, [_vm._v(_vm._s(_vm.$t("rolesType.rolesType")))]), _vm._v(" "), _c("multiselect", {
    attrs: {
...
var render = function render() {
  ...
  return _c("Layout", [_c("PageHeader"), _vm._v(" "), _c("Role", {
    ...
    attrs: {
      id: "create",
      title: _vm.$t("general.addroleWorkflow"),
      "title-class": "font-18",
      "body-class": "p-4 ",
      "hide-footer": true
    },
    ...
    staticClass: "my-1 mr-2"
  }, [_vm._v(_vm._s(_vm.$t("roles.roles")))]), _vm._v(" "), _c("multiselect", {
    attrs: {
  ...
  }, [_c("span", [_vm._v(_vm._s(_vm.$t("roles.roles")))])])]) : _vm._e(), _vm._v(" "), _vm.setting.workflow_id ? _c("th", [_c("div", {
    staticClass: "d-flex justify-content-center"
