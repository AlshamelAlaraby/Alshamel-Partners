  ...
  methods: {
    ...
    AddSubmit: function AddSubmit() {
      ...
      if (this.$v.create.$invalid) {
        ...
        this.isLoader = true;
        this.errors = {};
        _api_adminAxios__WEBPACK_IMPORTED_MODULE_2__["default"].post("/colors", this.create).then(function (res) {
...
var render = function render() {
  ...
  })])])]), _vm._v(" "), _vm.colors.length > 0 ? _c("tbody", _vm._l(_vm.colors, function (data, index) {
    return _c("tr", {
      key: data.id,
