...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  methods: {
    ...
    getData: function getData() {
      ...
      this.isLoader = true;
      _api_adminAxios__WEBPACK_IMPORTED_MODULE_2__["default"].get("/cities?page=".concat(page, "&per_page=").concat(this.per_page, "&search=").concat(this.search)).then(function (res) {
        var l = res.data;
    ...
    getDataCurrentPage: function getDataCurrentPage() {
      ...
      if (this.current_page <= this.citiesPagination.last_page && this.current_page != this.citiesPagination.current_page && this.current_page) {
        this.isLoader = true;
        _api_adminAxios__WEBPACK_IMPORTED_MODULE_2__["default"].get("/cities?page=".concat(this.current_page, "&per_page=").concat(this.per_page, "&search=").concat(this.search)).then(function (res) {
          var l = res.data;
          _this4.cities = l.data;
          _this4.citiesPagination = l.pagination;
    ...
    AddSubmit: function AddSubmit() {
      ...
      if (this.$v.create.$invalid) {
        ...
        this.isLoader = true;
        this.errors = {};
        _api_adminAxios__WEBPACK_IMPORTED_MODULE_2__["default"].post("/cities", this.create).then(function (res) {
    ...
    resetModalEdit: function resetModalEdit(id) {
      var city = this.cities.find(function (e) {
        return id == e.id;
      });
...
var render = function render() {
  ...
  }, [_vm._v(_vm._s(_vm.$t("general.governorate")))])], 1)], 1), _vm._v(" "), _c("div", {
  ...
  }, [_vm._v("\n                                        " + _vm._s(_vm.citiesPagination.from) + "-" + _vm._s(_vm.citiesPagination.to) + " / " + _vm._s(_vm.citiesPagination.total) + "\n                                    ")]), _vm._v(" "), _c("div", {
    staticClass: "d-inline-block"
  }, [_c("a", {
    style: {
