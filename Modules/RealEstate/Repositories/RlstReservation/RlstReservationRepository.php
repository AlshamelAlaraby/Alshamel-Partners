...
class RlstReservationRepository implements RlstReservationRepositoryInterface
{

    private $model;
    public function __construct(RlstReservation $model)
    {
        $this->model = $model;
    }
    ...
    public function getAllRlstReservations($request)
    {
        ...
        if ($request->per_page) {
            return ['data' => RlstReservationResource::collection($models->paginate($request->per_page)), 'paginate' => true];
        } else {
            return ['data' => RlstReservationResource::collection($models->get()), 'paginate' => false];
        }
    }
