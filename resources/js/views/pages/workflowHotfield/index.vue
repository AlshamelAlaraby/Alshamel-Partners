    ...
    methods: {
        ...
        deleteModule(id) {
            Swal.fire({
                ...
                if (result.value) {
                    ...
                    adminApi.delete(`/role-screen-hotfield/${id}`)
                        .then((res) => {
                            this.getData();
                            this.checkAll = [];
                            Swal.fire({
        ...
        AddSubmit() {
            ...
            if (this.$v.create.$invalid) {
                ...
                this.isLoader = true;
                this.errors = {};
                adminApi.post(`/role-screen-hotfield`, this.create)
                    .then((res) => {
                                ...
                                <div class="d-fex">
                                    ...
                                    <div class="d-inline-flex align-items-center pagination-custom">
                                        <div class="d-inline-block" style="font-size:13px;">
                                            {{ roleWorkflowHotfieldsPagination.from }}-{{ roleWorkflowHotfieldsPagination.to }} /
                                            {{ roleWorkflowHotfieldsPagination.total }}
                                        </div>
                                        <div class="d-inline-block">
                                            <a
                                                href="javascript:void(0)"
                                                :style="{'pointer-events':roleWorkflowHotfieldsPagination.current_page == 1 ? 'none': ''}"
                                                @click.prevent="getData(roleWorkflowHotfieldsPagination.current_page - 1)"
                                            >
                                                <span>&lt;</span>
                                            </a>
                                            <input
                                            ...
                                            <a
                                                href="javascript:void(0)"
                                                :style="{'pointer-events':roleWorkflowHotfieldsPagination.last_page == roleWorkflowHotfieldsPagination.current_page ? 'none': ''}"
                                                @click.prevent="getData(roleWorkflowHotfieldsPagination.current_page + 1)"
                                            >
                                                <span>&gt;</span>
                                            </a>
