...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  validations: {
    create: {
      ...
      short_code: {
        required: vuelidate_lib_validators__WEBPACK_IMPORTED_MODULE_10__.required,
        alpha: vuelidate_lib_validators__WEBPACK_IMPORTED_MODULE_10__.alpha,
    ...
    * */
    ...
    addImage: function addImage(file) {
      ...
      reader.onload = function (e) {
        _this11.images.push("".concat(e.target.result));
        _this11.showPhoto = "".concat(e.target.result);
      };
