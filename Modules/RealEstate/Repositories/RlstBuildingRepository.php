...
class RlstBuildingRepository implements RlstBuildingRepositoryInterface
{

    private $model;
    private $setting;

    public function __construct(RlstBuilding $model, UserSettingScreen $setting)
    {
        $this->model = $model;
