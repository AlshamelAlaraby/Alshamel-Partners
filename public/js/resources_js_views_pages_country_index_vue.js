  ...
  validations: {
    create: {
      ...
      national_id_length: {
        ...
        maxLength: (0,vuelidate_lib_validators__WEBPACK_IMPORTED_MODULE_8__.maxLength)(20)
      },
      is_active: {
        required: vuelidate_lib_validators__WEBPACK_IMPORTED_MODULE_8__.required
      },
      ...
      if (file) {
        ...
        if (!this.idDelete) {
          ...
          _api_adminAxios__WEBPACK_IMPORTED_MODULE_2__["default"].post("/media", formDate).then(function (res) {
            var old_media = [];
            _this12.images.forEach(function (e) {
            ...
            _api_adminAxios__WEBPACK_IMPORTED_MODULE_2__["default"].put("/countries/".concat(_this12.country_id), {
              old_media: old_media,
              'media': new_media
            }).then(function (res) {
              var _res$data$data$media;
              _this12.images = (_res$data$data$media = res.data.data.media) !== null && _res$data$data$media !== void 0 ? _res$data$data$media : [];
          ...
          sweetalert2__WEBPACK_IMPORTED_MODULE_4___default().fire({
            ...
            if (result.value) {
              ...
              _formDate.append('media[0]', _this12.media);
              _api_adminAxios__WEBPACK_IMPORTED_MODULE_2__["default"].post("/media", _formDate).then(function (res) {
                var old_media = [];
                _this12.images.forEach(function (e) {
                  return old_media.push(e.id);
                });
                old_media.splice(old_media.indexOf(_this12.idDelete), 1);
                var new_media = [];
                res.data.data.forEach(function (e) {
                  return new_media.push(e.id);
                });
                _api_adminAxios__WEBPACK_IMPORTED_MODULE_2__["default"].put("/countries/".concat(_this12.country_id), {
                  ...
                  _this12.images = (_res$data$data$media2 = res.data.data.media) !== null && _res$data$data$media2 !== void 0 ? _res$data$data$media2 : [];
                  if (_this12.images && _this12.images.length > 0) {
                    _this12.showPhoto = _this12.images[_this12.images.length - 1].webp;
                  } else {
                    _this12.images = './images/img-1.png';
