  ...
  methods: {
    ...
    getDataCurrentPage: function getDataCurrentPage() {
      ...
      if (this.current_page <= this.citiesPagination.last_page && this.current_page != this.citiesPagination.current_page && this.current_page) {
        ...
        _api_adminAxios__WEBPACK_IMPORTED_MODULE_2__["default"].get("/cities?page=".concat(page, "&per_page=").concat(this.per_page, "&search=").concat(this.search, "&columns=").concat(filter)).then(function (res) {
          var l = res.data;
          _this5.cities = l.data;
          _this5.citiesPagination = l.pagination;
        ...
        return _regeneratorRuntime().wrap(function _callee2$(_context2) {
          while (1) {
            switch (_context2.prev = _context2.next) {
              case 0:
                city = _this11.cities.find(function (e) {
                  return id == e.id;
                });
                _context2.next = 3;
              ...
              case 3:
                _context2.next = 5;
                return _this11.getGovernorate(city.country.id);
              case 5:
                _this11.edit.name = city.name;
                _this11.edit.name_e = city.name_e;
                _this11.edit.is_active = city.is_active ? 1 : 0;
                _this11.edit.country_id = city.country.id;
                _this11.edit.governorate_id = city.governorate.id;
                _this11.errors = {};
              case 11:
              case "end":
...
var render = function render() {
  ...
  }), _vm._v(" "), _c("Governate"), _vm._v(" "), _c("div", {
    staticClass: "row"
  }, [_c("div", {
    staticClass: "col-12"
  }, [_c("div", {
  ...
  }, [_vm._v(_vm._s(_vm.getCompanyKey("city_name_ar")))]), _vm._v(" "), _c("b-form-checkbox", {
    staticClass: "mb-1",
    attrs: {
      value: "name_e"
    },
  ...
  }, [_vm._v(_vm._s(_vm.getCompanyKey("city_name_en")))]), _vm._v(" "), _c("b-form-checkbox", {
    staticClass: "mb-1",
    attrs: {
