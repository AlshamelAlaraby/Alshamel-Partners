...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  methods: {
    ...
    getData: function getData() {
      ...
      this.isLoader = true;
      _api_adminAxios__WEBPACK_IMPORTED_MODULE_2__["default"].get("/stores?page=".concat(page, "&per_page=").concat(this.per_page, "&company_id=").concat(this.company_id)).then(function (res) {
        var l = res.data;
    ...
    getDataCurrentPage: function getDataCurrentPage() {
      ...
      if (this.current_page <= this.storesPagination.last_page && this.current_page != this.storesPagination.current_page && this.current_page) {
        this.isLoader = true;
        _api_adminAxios__WEBPACK_IMPORTED_MODULE_2__["default"].get("/stores?page=".concat(page, "&per_page=").concat(this.per_page, "&search=").concat(this.search, "&columns=").concat(this.filterSetting, "&company_id=").concat(this.company_id)).then(function (res) {
          var l = res.data;
      ...
      return _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
        ...
        return _regeneratorRuntime().wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                branch = _this10.stores.find(function (e) {
                  return id == e.id;
                });
                _this10.edit.name = branch.name;
                _this10.edit.name_e = branch.name_e;
                _this10.edit.is_active = branch.is_active;
                _context.next = 6;
