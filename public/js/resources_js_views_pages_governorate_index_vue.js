      ...
      return _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
        ...
        return _regeneratorRuntime().wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                governorate = _this11.governorates.find(function (e) {
                  return id == e.id;
                });
                _this11.edit.name = governorate.name;
                _this11.edit.name_e = governorate.name_e;
                _this11.edit.is_active = governorate.is_active;
                _context.next = 6;
                return _this11.getCategory();
              case 6:
                _this11.edit.country_id = governorate.country.id;
                _this11.edit.phone_key = governorate.phone_key;
                _this11.errors = {};
              case 9:
              case "end":
                return _context.stop();
...
var render = function render() {
  ...
  return _c("Layout", [_c("PageHeader"), _vm._v(" "), _c("Country", {
  ...
  }, [_vm._v(_vm._s(_vm.$t("general.country")) + "\n                                    ")]), _vm._v(" "), _c("b-form-checkbox", {
    staticClass: "mb-1",
    attrs: {
      value: "phone_key"
    },
  ...
  }, [_vm._v(_vm._s(_vm.$t("general.phone_key")) + "\n                                    ")])], 1)], 1), _vm._v(" "), _c("div", {
    ...
    return _c("tr", {
      ...
      staticClass: "m-0 font-weight-normal"
    }, [_vm._v(_vm._s(data.name_e))])]) : _vm._e(), _vm._v(" "), _vm.setting.phone_key ? _c("td", [_vm._v(_vm._s(data.phone_key))]) : _vm._e(), _vm._v(" "), _vm.setting.country_id ? _c("td", [_vm._v("\n                                    " + _vm._s(_vm.$i18n.locale == "ar" ? data.country.name : data.country.name_e) + "\n                                ")]) : _vm._e(), _vm._v(" "), _vm.setting.is_default ? _c("td", [_c("span", {
