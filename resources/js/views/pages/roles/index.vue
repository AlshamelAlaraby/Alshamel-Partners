...
export default {
  ...
  data() {
    return {
      ...
      filterSetting: [
        "name",
        "name_e",
        this.$i18n.locale == "ar" ? "roleType.name" : "roleType.name_e",
      ],
      Tooltip: "",
      mouseEnter: null,
    };
  ...
  methods: {
    ...
    getDataCurrentPage(page = 1) {
      if (
        this.current_page <= this.rolesPagination.last_page &&
        this.current_page != this.rolesPagination.current_page &&
        this.current_page
      ) {
        this.isLoader = true;
        let filter = "";
    ...
    editSubmit(id) {
      ...
      if (this.$v.edit.$invalid) {
        ...
        adminApi
          .put(`/roles/${id}`, { name, name_e, roletype_id })
          .then((res) => {
                  ...
                  <div class="d-inline-flex align-items-center pagination-custom">
                    ...
                    <div class="d-inline-block">
                      <a
                        ...
                        :style="{
                          'pointer-events':
                            rolesPagination.current_page == 1 ? 'none' : '',
                        }"
                      ...
                      <a
                        ...
                        :style="{
                          'pointer-events':
                            rolesPagination.last_page == rolesPagination.current_page
                              ? 'none'
                              : '',
                        }"
                        @click.prevent="getData(rolesPagination.current_page + 1)"
                      ...
                      <div class="d-flex justify-content-center">
                        ...
                        <div class="arrow-sort">
                          <i
                            ...
                            @click="roles.sort(sortString('name'))"
                          ></i>
                          <i
                    ...
                    <th v-if="setting.name_e">
                      <div class="d-flex justify-content-center">
                        ...
                        <div class="arrow-sort">
                          <i
                            class="fas fa-arrow-up"
                            @click="roles.sort(sortString('name_e'))"
                          ></i>
                          <i
                            class="fas fa-arrow-down"
                            @click="roles.sort(sortString('-name_e'))"
                  ...
                  >
                    ...
                    <td>
                      ...
                      <b-modal
                        ...
                        :title="getCompanyKey('role_edit_form')"
                        title-class="font-18"
                        body-class="p-4"
                        :ref="`edit-${data.id}`"
                        :hide-footer="true"
