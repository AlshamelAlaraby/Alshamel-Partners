  ...
  methods: {
    ...
    getData: function getData() {
      ...
      _api_adminAxios__WEBPACK_IMPORTED_MODULE_2__["default"].get("/tree-properties?page=".concat(page, "&per_page=").concat(this.per_page, "&search=").concat(this.search, "&").concat(filter)).then(function (res) {
        var l = res.data;
        _this3.treeProperties = l.data;
        _this3.treePropertiesPagination = l.pagination;
            ...
            switch (_context2.prev = _context2.next) {
              case 0:
                ...
                return _api_adminAxios__WEBPACK_IMPORTED_MODULE_2__["default"].get("/tree-properties/root-nodes").then(function (res) {
                  console.log(_this11.rootNodes);
                  _this11.rootNodes = res.data;
                })["catch"](function (err) {
                  sweetalert2__WEBPACK_IMPORTED_MODULE_4___default().fire({
                    icon: "error",
    ...
    getFirstLevelChildNodes: function getFirstLevelChildNodes(node) {
      ...
      if (!node.collapsed) {
        _api_adminAxios__WEBPACK_IMPORTED_MODULE_2__["default"].get("/tree-properties/child-nodes/".concat(node.id)).then(function (res) {
          _this12.rootNodes = _this12.getUpdatedRootNodes(node, res.data);
        })["catch"](function (err) {
          sweetalert2__WEBPACK_IMPORTED_MODULE_4___default().fire({
            icon: "error",
    ...
    getSecondLevelChildNodes: function getSecondLevelChildNodes(rootNode, parentNode) {
      ...
      if (!parentNode.collapsed) {
        _api_adminAxios__WEBPACK_IMPORTED_MODULE_2__["default"].get("/tree-properties/child-nodes/".concat(parentNode.id)).then(function (res) {
          _this13.rootNodes = _this13.getRootNodesAfterCollapse(rootNode, parentNode, res.data);
        })["catch"](function (err) {
          sweetalert2__WEBPACK_IMPORTED_MODULE_4___default().fire({
            icon: "error",
    ...
    getThirdLevelChildNodes: function getThirdLevelChildNodes(rootNode, parentNode, secondParentNode) {
      ...
      if (!secondParentNode.collapsed) {
        _api_adminAxios__WEBPACK_IMPORTED_MODULE_2__["default"].get("/tree-properties/child-nodes/".concat(secondParentNode.id)).then(function (res) {
          _this14.rootNodes = _this14.getRootNodesAfter2ndCollapse(rootNode, parentNode, secondParentNode, res.data);
        })["catch"](function (err) {
          sweetalert2__WEBPACK_IMPORTED_MODULE_4___default().fire({
            icon: "error",
    ...
    getFourthLevelChildNodes: function getFourthLevelChildNodes(rootNode, parentNode, secondParentNode, thirdParentNode) {
      ...
      if (!thirdParentNode.collapsed) {
        _api_adminAxios__WEBPACK_IMPORTED_MODULE_2__["default"].get("/tree-properties/child-nodes/".concat(thirdParentNode.id)).then(function (res) {
          _this15.rootNodes = _this15.getRootNodesAfter3rdCollapse(rootNode, parentNode, secondParentNode, thirdParentNode, res.data);
        })["catch"](function (err) {
          sweetalert2__WEBPACK_IMPORTED_MODULE_4___default().fire({
            icon: "error",
        ...
        return _regeneratorRuntime().wrap(function _callee3$(_context3) {
          while (1) {
            switch (_context3.prev = _context3.next) {
              case 0:
                _this16.getRootNodes();
                propertyTree = _this16.treeProperties.find(function (e) {
                  return id == e.id;
                });
                _this16.edit.name = propertyTree.name;
                _this16.edit.name_e = propertyTree.name_e;
                _this16.edit.required = propertyTree.required == 1 ? "active" : "inactive";
                _this16.edit.parent_id = propertyTree.parent_id;
                _this16.errors = {};
                _this16.current_id = id;
              case 8:
              case "end":
...
var render = function render() {
  ...
  return _c("Layout", [_c("PageHeader"), _vm._v(" "), _c("div", {
    ...
    staticClass: "d-flex justify-content-center"
  }, [_c("span", [_vm._v(_vm._s(_vm.$t("general.Required")))]), _vm._v(" "), _c("div", {
    staticClass: "arrow-sort"
  }, [_c("i", {
    staticClass: "fas fa-arrow-up",
    on: {
  ...
  })])])]), _vm._v(" "), _vm.treeProperties.length > 0 ? _c("tbody", _vm._l(_vm.treeProperties, function (data, index) {
    return _c("tr", {
      key: data.id,
