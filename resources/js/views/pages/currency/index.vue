...
export default {
  page: {
    ...
    beforeRouteEnter(to, from, next) {
        next((vm) => {
            if (vm.$store.state.auth.work_flow_trees.includes('currencies')) {
                return true;
            } else {
  ...
  methods: {
    ...
    getData(page = 1) {
      ...
      adminApi
        .get(
          `/currencies?page=${page}&per_page=${this.per_page}&search=${this.search}&${filter}`
        )
        .then((res) => {
          let l = res.data;
    ...
    getDataCurrentPage(page = 1) {
      if (
        this.current_page <= this.currenciesPagination.last_page &&
        this.current_page != this.currenciesPagination.current_page &&
        this.current_page
      ) {
        this.isLoader = true;
        let filter = "";
                ...
                <div class="d-inline-block" style="width: 22.2%">
                  ...
                  >
                    ...
                    <b-form-checkbox
                      ...
                      value="code_e"
                      class="mb-1"
                      >{{ getCompanyKey('currency_code_en') }}</b-form-checkbox
                    >
                    <b-form-checkbox
                      v-model="filterSetting"
                      value="fraction"
                    ...
                    <b-form-checkbox
                      ...
                      value="fraction_e"
                      class="mb-1"
                      >{{ getCompanyKey('currency_fraction_en') }}</b-form-checkbox
                    >
                  </b-dropdown>
                  <!-- Basic dropdown -->
                </div>
                ...
                <div class="d-fex">
                  ...
                  <div class="d-inline-flex align-items-center pagination-custom">
                    <div class="d-inline-block" style="font-size: 13px">
                      {{ currenciesPagination.from }}-{{ currenciesPagination.to }} /
                      {{ currenciesPagination.total }}
                    </div>
                    <div class="d-inline-block">
                      <a
                        ...
                        :style="{
                          'pointer-events':
                            currenciesPagination.current_page == 1 ? 'none' : '',
                        }"
                      ...
                      <a
                        ...
                        :style="{
                          'pointer-events':
                            currenciesPagination.last_page ==
                            currenciesPagination.current_page
                              ? 'none'
                              : '',
                        }"
                        @click.prevent="getData(currenciesPagination.current_page + 1)"
                      ...
                      <div class="d-flex justify-content-center">
                        ...
                        <div class="arrow-sort">
                          <i
                            ...
                            @click="currencies.sort(sortString('name'))"
                          ></i>
                          <i
                    ...
                    <th v-if="setting.name_e">
                      <div class="d-flex justify-content-center">
                        ...
                        <div class="arrow-sort">
                          <i
                            class="fas fa-arrow-up"
                            @click="currencies.sort(sortString('name_e'))"
                          ></i>
                          <i
                            class="fas fa-arrow-down"
                            @click="currencies.sort(sortString('-name_e'))"
                    ...
                    <th v-if="setting.code">
                      <div class="d-flex justify-content-center">
                        ...
                        <div class="arrow-sort">
                          <i
                            class="fas fa-arrow-up"
                            @click="currencies.sort(sortString('code'))"
                          ></i>
                          <i
                            class="fas fa-arrow-down"
                            @click="currencies.sort(sortString('-code'))"
                    ...
                    <th v-if="setting.code_e">
                      <div class="d-flex justify-content-center">
                        ...
                        <div class="arrow-sort">
                          <i
                            class="fas fa-arrow-up"
                            @click="currencies.sort(sortString('code_e'))"
                          ></i>
                          <i
                            class="fas fa-arrow-down"
                            @click="currencies.sort(sortString('-code_e'))"
                    ...
                    <th v-if="setting.fraction">
                      <div class="d-flex justify-content-center">
                        ...
                        <div class="arrow-sort">
                          <i
                            class="fas fa-arrow-up"
                            @click="currencies.sort(sortString('fraction'))"
                          ></i>
                          <i
                            class="fas fa-arrow-down"
                            @click="currencies.sort(sortString('-fraction'))"
                    ...
                    <th v-if="setting.fraction_e">
                      <div class="d-flex justify-content-center">
                        ...
                        <div class="arrow-sort">
                          <i
                            class="fas fa-arrow-up"
                            @click="currencies.sort(sortString('fraction_e'))"
                          ></i>
                          <i
                            class="fas fa-arrow-down"
                            @click="currencies.sort(sortString('-fraction_e'))"
                    ...
                    <th v-if="setting.symbol">
                      <div class="d-flex justify-content-center">
                        ...
                        <div class="arrow-sort">
                          <i
                            class="fas fa-arrow-up"
                            @click="currencies.sort(sortString('symbol'))"
                          ></i>
                          <i
                            class="fas fa-arrow-down"
                            @click="currencies.sort(sortString('-symbol'))"
                    ...
                    <th v-if="setting.symbol_e">
                      <div class="d-flex justify-content-center">
                        ...
                        <div class="arrow-sort">
                          <i
                            class="fas fa-arrow-up"
                            @click="currencies.sort(sortString('symbol_e'))"
                          ></i>
                          <i
                            class="fas fa-arrow-down"
                            @click="currencies.sort(sortString('-symbol_e'))"
                    ...
                    <th v-if="setting.fraction_no">
                      <div class="d-flex justify-content-center">
                        ...
                        <div class="arrow-sort">
                          <i
                            class="fas fa-arrow-up"
                            @click="currencies.sort(SortNumber('fraction_no'))"
                          ></i>
                          <i
                            class="fas fa-arrow-down"
                            @click="currencies.sort(SortNumber('-fraction_no'))"
                  ...
                  >
                    ...
                    <td>
                      ...
                      <b-modal
                        ...
                        :title="getCompanyKey('currency_edit_form')"
                        title-class="font-18"
                        body-class="p-4"
                        dialog-class="modal-full-width"
                        :ref="`edit-${data.id}`"
                          ...
                          <div class="row">
                              ...
                              <div class="form-group">
                                ...
                                <div dir="rtl">
                                  <input
                                    ...
                                    :class="{
                                      'is-invalid':
                                        $v.edit.symbol.$error || errors.symbol,
                                      'is-valid':
                                        !$v.edit.symbol.$invalid && !errors.symbol,
                                    }"
                                    id="edit-45"
                                  />
                                </div>
                                <div
                                  v-if="!$v.edit.symbol.minLength"
                                  class="invalid-feedback"
                                >
                                  {{ $t("general.Itmustbeatleast") }}
                                  {{ $v.edit.symbol.$params.minLength.min }}
                                  {{ $t("general.letters") }}
                                </div>
                                <div
                                  v-if="!$v.edit.symbol.maxLength"
                                  class="invalid-feedback"
                                >
                                  {{ $t("general.Itmustbeatmost") }}
                                  {{ $v.edit.symbol.$params.maxLength.max }}
                                  {{ $t("general.letters") }}
                                </div>
                                <template v-if="errors.symbol">
                                  <ErrorMessage
                            ...
                            <div class="col-md-3">
                              <div class="form-group">
                                ...
                                <div
                                  v-if="!$v.edit.code.minLength"
                                  class="invalid-feedback"
                                >
                                  {{ $t("general.Itmustbeatleast") }}
                                  {{ $v.edit.code.$params.minLength.min }}
                                  {{ $t("general.letters") }}
                                </div>
                                <div
                              ...
                              <div class="form-group">
                                ...
                                <div dir="rtl">
                                  <input
                                    ...
                                    :class="{
                                      'is-invalid':
                                        $v.edit.fraction.$error || errors.fraction,
                                      'is-valid':
                                        !$v.edit.fraction.$invalid && !errors.fraction,
                                    }"
                                    id="edit-5"
                                  />
                                </div>
                                <div
                                  v-if="!$v.edit.fraction.minLength"
                                  class="invalid-feedback"
                                >
                                  {{ $t("general.Itmustbeatleast") }}
                                  {{ $v.edit.fraction.$params.minLength.min }}
                                  {{ $t("general.letters") }}
                                </div>
                                <div
                                  v-if="!$v.edit.fraction.maxLength"
                                  class="invalid-feedback"
                                >
                                  {{ $t("general.Itmustbeatmost") }}
                                  {{ $v.edit.fraction.$params.maxLength.max }}
                                  {{ $t("general.letters") }}
                                </div>
                                <template v-if="errors.fraction">
                                  <ErrorMessage
                              ...
                              <div class="form-group">
                                ...
                                <div dir="ltr">
                                  <input
                                    ...
                                    :class="{
                                      'is-invalid':
                                        $v.edit.fraction_e.$error || errors.fraction_e,
                                      'is-valid':
                                        !$v.edit.fraction_e.$invalid &&
                                        !errors.fraction_e,
                                    }"
                                    id="edit-6"
                                  />
                                ...
                                <div
                                  v-if="!$v.edit.fraction_e.minLength"
                                  class="invalid-feedback"
                                >
                                  {{ $t("general.Itmustbeatleast") }}
                                  {{ $v.edit.fraction_e.$params.minLength.min }}
                                  {{ $t("general.letters") }}
                                </div>
                                <div
                                  v-if="!$v.edit.fraction_e.maxLength"
                                  class="invalid-feedback"
                                >
                                  {{ $t("general.Itmustbeatmost") }}
                                  {{ $v.edit.fraction_e.$params.maxLength.max }}
                                  {{ $t("general.letters") }}
                                </div>
                                <template v-if="errors.fraction_e">
                                  <ErrorMessage
                            ...
                            <div class="col-md-3">
                              <div class="form-group">
                                ...
                                <input
                                  ...
                                  :class="{
                                    'is-invalid':
                                      $v.edit.fraction_no.$error || errors.fraction_no,
                                    'is-valid':
                                      !$v.edit.fraction_no.$invalid &&
                                      !errors.fraction_no,
                                  }"
                                  id="edit-7"
                                />
