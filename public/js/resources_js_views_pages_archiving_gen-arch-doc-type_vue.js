(self["webpackChunk"] = self["webpackChunk"] || []).push([["resources_js_views_pages_archiving_gen-arch-doc-type_vue"],{
...
/***/ "./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/views/pages/archiving/gen-arch-doc-type.vue?vue&type=script&lang=js&":
/*!***********************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/views/pages/archiving/gen-arch-doc-type.vue?vue&type=script&lang=js& ***!
  \***********************************************************************************************************************************************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  watch: {
    ...
    isCheckAll: function isCheckAll(after, befour) {
      var _this2 = this;
      if (after) {
        this.genArchDocType.forEach(function (el) {
  ...
  methods: {
    ...
    getData: function getData() {
      ...
      _api_adminAxios__WEBPACK_IMPORTED_MODULE_2__["default"].get("/gen-arch-doc-type?page=".concat(page, "&per_page=").concat(this.per_page, "&search=").concat(this.search, "&").concat(filter)).then(function (res) {
        var l = res.data;
        _this3.genArchDocType = l.data;
        _this3.genArchDocTypePagination = l.pagination;
    ...
    getDataCurrentPage: function getDataCurrentPage() {
      var _this4 = this;
      if (this.current_page <= this.genArchDocTypePagination.last_page && this.current_page != this.genArchDocTypePagination.current_page && this.current_page) {
        this.isLoader = true;
        var filter = "";
        for (var i = 0; i > this.filterSetting.length; ++i) {
          filter += "columns[".concat(i, "]=").concat(this.filterSetting[i], "&");
        }
        _api_adminAxios__WEBPACK_IMPORTED_MODULE_2__["default"].get("/gen-arch-doc-type?page=".concat(this.current_page, "&per_page=").concat(this.per_page, "&search=").concat(this.search, "&").concat(filter)).then(function (res) {
          var l = res.data;
          _this4.genArchDocType = l.data;
          _this4.genArchDocTypePagination = l.pagination;
     ...
     */
    deleteGenArchDocType: function deleteGenArchDocType(id) {
      var _this5 = this;
      sweetalert2__WEBPACK_IMPORTED_MODULE_3___default().fire({
        ...
        if (result.value) {
          ...
          _api_adminAxios__WEBPACK_IMPORTED_MODULE_2__["default"]["delete"]("/gen-arch-doc-type/".concat(id)).then(function (res) {
            _this5.getData();
            _this5.checkAll = [];
            sweetalert2__WEBPACK_IMPORTED_MODULE_3___default().fire({
              icon: "success",
     ...
     */
    bulkDeleteGenArchDocType: function bulkDeleteGenArchDocType(id) {
      var _this6 = this;
      sweetalert2__WEBPACK_IMPORTED_MODULE_3___default().fire({
        title: "".concat(this.$t("general.Areyousure")),
        text: "".concat(this.$t("general.Youwontbeabletoreverthis")),
        ...
        if (result.value) {
          ...
          _api_adminAxios__WEBPACK_IMPORTED_MODULE_2__["default"].post("/gen-arch-doc-type/bulk-delete", {
            ids: id
          }).then(function (res) {
            _this6.getData();
            _this6.checkAll = [];
    ...
    editSubmit: function editSubmit(id) {
      ...
      if (this.$v.edit.$invalid) {
        ...
        var _this$edit = this.edit,
          ...
          is_valid = _this$edit.is_valid,
          parent_id = _this$edit.parent_id;
        _api_adminAxios__WEBPACK_IMPORTED_MODULE_2__["default"].put("/gen-arch-doc-type/".concat(id), {
          name: name,
          name_e: name_e,
        ...
        return _regeneratorRuntime().wrap(function _callee3$(_context3) {
          while (1) {
            switch (_context3.prev = _context3.next) {
              ...
              case 2:
                editGenDocType = _this13.genArchDocType.find(function (e) {
                  return id == e.id;
                });
                _this13.edit.name = editGenDocType.name;
                _this13.edit.name_e = editGenDocType.name_e;
                _this13.edit.parent_id = editGenDocType.parent_id ? editGenDocType.parent_id.id : '';
                _this13.edit.is_valid = editGenDocType.is_valid;
                _this13.errors = {};
              case 8:
              case "end":
...
/***/ "./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/loaders/templateLoader.js??ruleSet[1].rules[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/views/pages/archiving/gen-arch-doc-type.vue?vue&type=template&id=793709bf&":
/*!**********************************************************************************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/loaders/templateLoader.js??ruleSet[1].rules[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/views/pages/archiving/gen-arch-doc-type.vue?vue&type=template&id=793709bf& ***!
  \**********************************************************************************************************************************************************************************************************************************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
var render = function render() {
  ...
  return _c("Layout", [_c("PageHeader"), _vm._v(" "), _c("div", {
  ...
  }, [_vm._v(_vm._s(_vm.$t("GenArchDocType.GenArchDocTypeTable")))]), _vm._v(" "), _c("div", {
    ...
    on: {
      click: function click($event) {
        $event.preventDefault();
        return _vm.bulkDeleteGenArchDocType(_vm.checkAll);
      }
    }
  }, [_c("i", {
    ...
    on: {
      click: function click($event) {
        $event.preventDefault();
        return _vm.deleteGenArchDocType(_vm.checkAll);
      }
    }
  }, [_c("i", {
    staticClass: "fas fa-trash-alt"
    ...
    staticClass: "mb-1",
    model: {
      value: _vm.setting.is_valid,
      callback: function callback($$v) {
        _vm.$set(_vm.setting, "is_valid", $$v);
      },
      expression: "setting.is_valid"
    }
  ...
  }, [_vm._v("\n                    " + _vm._s(_vm.genArchDocTypePagination.from) + "-" + _vm._s(_vm.genArchDocTypePagination.to) + " /\n                    " + _vm._s(_vm.genArchDocTypePagination.total) + "\n                  ")]), _vm._v(" "), _c("div", {
    staticClass: "d-inline-block"
  }, [_c("a", {
    style: {
      "pointer-events": _vm.genArchDocTypePagination.current_page == 1 ? "none" : ""
    },
    attrs: {
      href: "javascript:void(0)"
    },
    on: {
      click: function click($event) {
        $event.preventDefault();
        return _vm.getData(_vm.genArchDocTypePagination.current_page - 1);
      }
    }
    ...
    style: {
      "pointer-events": _vm.genArchDocTypePagination.last_page == _vm.genArchDocTypePagination.current_page ? "none" : ""
    },
    attrs: {
      href: "javascript:void(0)"
    },
    ...
    on: {
      click: function click($event) {
        _vm.genArchDocType.sort(_vm.sortString("name"));
      }
    }
  }), _vm._v(" "), _c("i", {
    ...
    on: {
      click: function click($event) {
        _vm.genArchDocType.sort(_vm.sortString("name_e"));
      }
    }
  }), _vm._v(" "), _c("i", {
    staticClass: "fas fa-arrow-down",
  ...
  })])])]) : _vm._e(), _vm._v(" "), _vm.setting.is_valid ? _c("th", [_c("div", {
    staticClass: "d-flex justify-content-center"
  }, [_c("span", [_vm._v(_vm._s(_vm.$t("general.isValid")))]), _vm._v(" "), _c("div", {
    staticClass: "arrow-sort"
  }, [_c("i", {
    staticClass: "fas fa-arrow-up",
    on: {
      click: function click($event) {
        _vm.genArchDocType.sort(_vm.sortString("is_valid"));
      }
    }
  }), _vm._v(" "), _c("i", {
    staticClass: "fas fa-arrow-down",
    ...
    on: {
      click: function click($event) {
        _vm.genArchDocType.sort(_vm.sortString("parent_id"));
      }
    }
  }), _vm._v(" "), _c("i", {
    staticClass: "fas fa-arrow-down",
  ...
  })])])]), _vm._v(" "), _vm.genArchDocType.length > 0 ? _c("tbody", _vm._l(_vm.genArchDocType, function (data, index) {
    return _c("tr", {
      key: data.id,
      ...
      staticClass: "m-0 font-weight-normal"
    }, [_vm._v(_vm._s(data.name_e))])]) : _vm._e(), _vm._v(" "), _vm.setting.is_valid ? _c("td", [_c("span", {
      "class": [data.is_valid == 1 ? "text-success" : "text-danger", "badge"]
    }, [_vm._v("\n                      " + _vm._s(data.is_valid == 1 ? "".concat(_vm.$t("general.Yes")) : "".concat(_vm.$t("general.No"))) + "\n                    ")])]) : _vm._e(), _vm._v(" "), _vm.setting.parent_id ? _c("td", [_c("h5", {
      staticClass: "m-0 font-weight-normal"
    }, [_vm._v(_vm._s(data.parent_id ? _vm.$i18n.locale == "ar" ? data.parent_id.name : data.parent_id.name_e : ""))])]) : _vm._e(), _vm._v(" "), _c("td", [_c("div", {
      ...
      on: {
        click: function click($event) {
          $event.preventDefault();
          return _vm.deleteGenArchDocType(data.id);
        }
      }
    }, [_c("div", {
      staticClass: "d-flex justify-content-between align-items-center text-black"
      ...
      attrs: {
        ...
        title: _vm.$t("GenArchDocType.EditGenArchDocType"),
        "title-class": "font-18",
        "body-class": "p-4",
        size: "lg",
        "hide-footer": true
      ...
      "class": {
        "is-invalid": _vm.$v.edit.is_valid.$error || _vm.errors.is_valid,
        "is-valid": !_vm.$v.edit.is_valid.$invalid && !_vm.errors.is_valid
      }
    }, [_c("b-form-radio", {
      staticClass: "d-inline-block",
      attrs: {
      ...
      model: {
        value: _vm.$v.edit.is_valid.$model,
        callback: function callback($$v) {
          _vm.$set(_vm.$v.edit.is_valid, "$model", $$v);
        },
        expression: "$v.edit.is_valid.$model"
      }
    }, [_vm._v(_vm._s(_vm.$t("general.isReferenceYes")))]), _vm._v(" "), _c("b-form-radio", {
      staticClass: "d-inline-block m-1",
      attrs: {
...
/***/ "./resources/js/views/pages/archiving/gen-arch-doc-type.vue":
/*!******************************************************************!*\
  !*** ./resources/js/views/pages/archiving/gen-arch-doc-type.vue ***!
  \******************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony import */ var _gen_arch_doc_type_vue_vue_type_template_id_793709bf___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./gen-arch-doc-type.vue?vue&type=template&id=793709bf& */ "./resources/js/views/pages/archiving/gen-arch-doc-type.vue?vue&type=template&id=793709bf&");
/* harmony import */ var _gen_arch_doc_type_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./gen-arch-doc-type.vue?vue&type=script&lang=js& */ "./resources/js/views/pages/archiving/gen-arch-doc-type.vue?vue&type=script&lang=js&");
/* harmony import */ var _node_modules_vue_loader_lib_runtime_componentNormalizer_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! !../../../../../node_modules/vue-loader/lib/runtime/componentNormalizer.js */ "./node_modules/vue-loader/lib/runtime/componentNormalizer.js");
...
var component = (0,_node_modules_vue_loader_lib_runtime_componentNormalizer_js__WEBPACK_IMPORTED_MODULE_2__["default"])(
  ...
  _gen_arch_doc_type_vue_vue_type_template_id_793709bf___WEBPACK_IMPORTED_MODULE_0__.render,
  _gen_arch_doc_type_vue_vue_type_template_id_793709bf___WEBPACK_IMPORTED_MODULE_0__.staticRenderFns,
  false,
  null,
  null,
  null
...
/* hot reload */
if (false) { var api; }
component.options.__file = "resources/js/views/pages/archiving/gen-arch-doc-type.vue"
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (component.exports);
...
/***/ "./resources/js/views/pages/archiving/gen-arch-doc-type.vue?vue&type=script&lang=js&":
/*!*******************************************************************************************!*\
  !*** ./resources/js/views/pages/archiving/gen-arch-doc-type.vue?vue&type=script&lang=js& ***!
  \*******************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/***/ "./resources/js/views/pages/archiving/gen-arch-doc-type.vue?vue&type=template&id=793709bf&":
/*!*************************************************************************************************!*\
  !*** ./resources/js/views/pages/archiving/gen-arch-doc-type.vue?vue&type=template&id=793709bf& ***!
  \*************************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "render": () => (/* reexport safe */ _node_modules_babel_loader_lib_index_js_clonedRuleSet_5_use_0_node_modules_vue_loader_lib_loaders_templateLoader_js_ruleSet_1_rules_2_node_modules_vue_loader_lib_index_js_vue_loader_options_gen_arch_doc_type_vue_vue_type_template_id_793709bf___WEBPACK_IMPORTED_MODULE_0__.render),
/* harmony export */   "staticRenderFns": () => (/* reexport safe */ _node_modules_babel_loader_lib_index_js_clonedRuleSet_5_use_0_node_modules_vue_loader_lib_loaders_templateLoader_js_ruleSet_1_rules_2_node_modules_vue_loader_lib_index_js_vue_loader_options_gen_arch_doc_type_vue_vue_type_template_id_793709bf___WEBPACK_IMPORTED_MODULE_0__.staticRenderFns)
/* harmony export */ });
/* harmony import */ var _node_modules_babel_loader_lib_index_js_clonedRuleSet_5_use_0_node_modules_vue_loader_lib_loaders_templateLoader_js_ruleSet_1_rules_2_node_modules_vue_loader_lib_index_js_vue_loader_options_gen_arch_doc_type_vue_vue_type_template_id_793709bf___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../../../node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!../../../../../node_modules/vue-loader/lib/loaders/templateLoader.js??ruleSet[1].rules[2]!../../../../../node_modules/vue-loader/lib/index.js??vue-loader-options!./gen-arch-doc-type.vue?vue&type=template&id=793709bf& */ "./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/loaders/templateLoader.js??ruleSet[1].rules[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/views/pages/archiving/gen-arch-doc-type.vue?vue&type=template&id=793709bf&");
