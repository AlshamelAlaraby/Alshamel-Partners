...
export default {
  ...
  methods: {
    ...
    getData(page = 1) {
      ...
      adminApi
        .get(
          `/salesmen?page=${page}&per_page=${this.per_page}&search=${this.search}&${filter}`
        )
        .then((res) => {
          let l = res.data;
    ...
    getDataCurrentPage(page = 1) {
      if (
        this.current_page <= this.salesmensPagination.last_page &&
        ...
        adminApi
          .get(
            `/salesmen?page=${this.current_page}&per_page=${this.per_page}&search=${this.search}&${filter}`
          )
          .then((res) => {
            let l = res.data;
            this.salesmens = l.data;
      ...
      if (Array.isArray(id)) {
        Swal.fire({
          ...
          if (result.value) {
            this.isLoader = true;
            adminApi
              .post(`/salesmen/bulk-delete`, { ids: id })
              .then((res) => {
                this.checkAll = [];
                this.getData();
                Swal.fire({
                  ...
                  <div class="d-inline-flex align-items-center pagination-custom">
                    ...
                    <div class="d-inline-block">
                      <a
                        ...
                        :style="{
                          'pointer-events':
                            salesmensPagination.current_page == 1 ? 'none' : '',
                        }"
                      ...
                      <a
                        ...
                        :style="{
                          'pointer-events':
                            salesmensPagination.last_page ==
                            salesmensPagination.current_page
                              ? 'none'
                              : '',
                        }"
                        @click.prevent="getData(salesmensPagination.current_page + 1)"
              ...
              <table class="table table-borderless table-hover table-centered m-0">
                      ...
                      <div class="d-flex justify-content-center">
                        ...
                        <div class="arrow-sort">
                          <i
                            ...
                            @click="salesmens.sort(sortString('name'))"
                          ></i>
                          <i
                    ...
                    <th v-if="setting.name_e">
                      <div class="d-flex justify-content-center">
                        ...
                        <div class="arrow-sort">
                          <i
                            class="fas fa-arrow-up"
                            @click="salesmens.sort(sortString('name_e'))"
                          ></i>
                          <i
                            class="fas fa-arrow-down"
                            @click="salesmens.sort(sortString('-name_e'))"
                ...
                <tbody v-if="salesmens.length > 0">
                  ...
                  >
                    ...
                    <td v-if="setting.salesman_type_id">
                      {{
                        $i18n.locale == "ar"
