...
export default {
  ...
  methods: {
    ...
    getData(page = 1) {
      ...
      adminApi
        .get(
          `/stores?page=${page}&per_page=${this.per_page}&company_id=${this.company_id}&search=${this.search}&${filter}`
        )
        .then((res) => {
          let l = res.data;
          this.stores = l.data;
    ...
    getDataCurrentPage(page = 1) {
      if (
        this.current_page <= this.storesPagination.last_page &&
        this.current_page != this.storesPagination.current_page &&
        this.current_page
      ) {
        this.isLoader = true;
        let filter = "";
        ...
        adminApi
          .get(
            `/stores?page=${this.current_page}&per_page=${this.per_page}&search=${this.search}&${filter}&company_id=${this.company_id}`
          )
          .then((res) => {
            let l = res.data;
            this.stores = l.data;
      ...
      if (Array.isArray(id)) {
        Swal.fire({
          ...
          if (result.value) {
            this.isLoader = true;
            adminApi
              .post(`/stores/bulk-delete`, { ids: id })
              .then((res) => {
                this.checkAll = [];
                this.getData();
                Swal.fire({
                ...
                <div class="d-fex">
                  ...
                  <div class="d-inline-flex align-items-center pagination-custom">
                    <div class="d-inline-block" style="font-size: 13px">
                      {{ storesPagination.from }}-{{ storesPagination.to }} /
                    ...
                    <div class="d-inline-block">
                      <a
                        ...
                        :style="{
                          'pointer-events':
                            storesPagination.current_page == 1 ? 'none' : '',
                        }"
                      ...
                      <a
                        ...
                        :style="{
                          'pointer-events':
                            storesPagination.last_page == storesPagination.current_page
                              ? 'none'
                              : '',
                        }"
                        @click.prevent="getData(storesPagination.current_page + 1)"
                      ...
                      <div class="d-flex justify-content-center">
                        ...
                        <div class="arrow-sort">
                          <i
                            ...
                            @click="stores.sort(sortString('name'))"
                          ></i>
                          <i
                    ...
                    <th v-if="setting.name_e">
                      <div class="d-flex justify-content-center">
                        ...
                        <div class="arrow-sort">
                          <i
                            class="fas fa-arrow-up"
                            @click="stores.sort(sortString('name_e'))"
                          ></i>
                          <i
                            class="fas fa-arrow-down"
                            @click="stores.sort(sortString('-name_e'))"
