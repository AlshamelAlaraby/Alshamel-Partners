                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6" v-if="create.country_id">
                                        <div class="form-group position-relative">
                                            ...
                                            <div v-if="$v.create.governorate_id.$error || errors.governorate_id"
                                                 class="text-danger">
                                                {{ $t('general.fieldIsRequired') }}
                                    ...
                                    <div class="col-md-6" v-if="create.governorate_id">
                                        <div class="form-group position-relative">
                                            <label  class="control-label">
                                                {{ $t('general.city') }}
                                                <span class="text-danger">*</span>
                                            ...
                                            <div v-if="$v.create.city_id.$error || errors.city_id"
                                                 class="text-danger">
                                                {{ $t('general.fieldIsRequired') }}
                                            </div>
                                ...
                                <tbody v-if="avenues.length > 0">
                                  ...
                                  >
                                    ...
                                    <td>
                                      ...
                                      <td>{{ $i18n.locale == 'ar' ? data.city.name : data.city.name_e }}</td>
                                      <td>
                                        <span :class="[
                                        ...
                                        >
                                            <form>
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-6" v-if="edit.country_id">
                                                        <div class="form-group position-relative">
                                                            <label  class="control-label">
                                                                {{ $t('general.governorate') }}
                                                                <span class="text-danger">*</span>
                                                            ...
                                                            <div v-if="$v.edit.governorate_id.$error || errors.governorate_id"
                                                                 class="text-danger">
                                                                {{ $t('general.fieldIsRequired') }}
                                                            </div>                                                             <template v-if="errors.governorate_id">
                                                            <ErrorMessage v-for="(errorMessage,index) in errors.governorate_id" :key="index">{{ errorMessage }}</ErrorMessage>
                                                    ...
                                                    <div class="col-md-6" v-if="edit.governorate_id">
                                                        <div class="form-group position-relative">
                                                            <label  class="control-label">
                                                                {{ $t('general.city') }}
                                                                <span class="text-danger">*</span>
                                                            ...
                                                            <div v-if="$v.edit.city_id.$error || errors.city_id"
                                                                 class="text-danger">
                                                                {{ $t('general.fieldIsRequired') }}
                                                            </div>                                                                <template v-if="errors.city_id">
                                                            <ErrorMessage v-for="(errorMessage,index) in errors.city_id" :key="index">{{ errorMessage }}</ErrorMessage>
                                                            </template>
                                                        </div>
                                                    </div>
