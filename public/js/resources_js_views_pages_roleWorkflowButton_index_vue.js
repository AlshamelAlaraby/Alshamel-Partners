...
var render = function render() {
  ...
  return _c("Layout", [_c("PageHeader"), _vm._v(" "), _c("Role", {
    ...
    return _c("tr", {
      ...
      staticClass: "m-0 font-weight-normal"
    }, [_vm._v(_vm._s(_vm.workflows.length > 0 ? _vm.$i18n.locale == "ar" ? _vm.workflows.find(function (x) {
      return x.id == data.workflow_id;
    }).name : _vm.workflows.find(function (x) {
      return x.id == data.workflow_id;
    }).name_e : ""))])]) : _vm._e(), _vm._v(" "), _vm.setting.button_id ? _c("td", [_c("h5", {
      staticClass: "m-0 font-weight-normal"
    }, [_vm._v(_vm._s(_vm.buttons.length > 0 ? _vm.$i18n.locale == "ar" ? _vm.buttons.find(function (x) {
