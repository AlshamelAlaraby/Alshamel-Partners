...
export default {
    page: {
        ...
        meta: [{name: "Sales Men Type", content: 'Sales Men Type'}],
    },
    components: {
        Layout,
        PageHeader,
    ...
    methods: {
        ...
        getData(page = 1) {
            ...
            adminApi.get(`/salesmen-types?page=${page}&per_page=${this.per_page}&search=${this.search}`)
                .then((res) => {
                    let l = res.data;
                    this.salesmenTypes = l.data;
                    this.salesmenTypesPagination = l.pagination;
        ...
        getDataCurrentPage() {
            if (this.current_page <= this.salesmenTypesPagination.last_page && this.current_page != this.salesmenTypesPagination.current_page && this.current_page) {
                ...
                adminApi.get(`/salesmen-types?page=${this.current_page}&per_page=${this.per_page}&search=${this.search}`)
                    .then((res) => {
                        let l = res.data;
                        this.salesmenTypes = l.data;
                        this.salesmenTypesPagination = l.pagination;
        ...
        deleteModule(id) {
            Swal.fire({
                ...
                if (result.value) {
                    ...
                    adminApi.delete(`/salesmen-types/${id}`)
                        .then((res) => {
                            this.getData();
                            this.checkAll = [];
                            Swal.fire({
        ...
        editSubmit(id) {
            ...
            if (this.$v.edit.$invalid) {
                ...
                this.isLoader = true;
                this.errors = {};
                let {name, name_e, is_employee} = this.edit;
                adminApi.put(`/salesmen-types/${id}`, {name, name_e, is_employee})
                    .then((res) => {
         ...
         */
        resetModalEdit(id) {
            let module = this.salesmenTypes.find(e => id == e.id);
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="row justify-content-between align-items-center mb-2">
                            <h4 class="header-title"> {{ $t('salesmen-types.Table') }}</h4>
                            <div class="col-xs-10 col-md-9 col-lg-7" style="font-weight: 500">
                                ...
                                <div class="d-inline-block" style="width: 22.2%;">
                                    ...
                                    <b-dropdown variant="primary" :text="$t('general.searchSetting')" ref="dropdown"
                                        ...
                                        <b-form-checkbox v-model="setting" value="is_employee" class="mb-1">
                                ...
                                <div class="d-fex">
                                    ...
                                    <div class="d-inline-flex align-items-center pagination-custom">
                                        <div class="d-inline-block" style="font-size:13px;">
                                            {{ salesmenTypesPagination.from }}-{{ salesmenTypesPagination.to }} /
                                            {{ salesmenTypesPagination.total }}
                                        </div>
                                        <div class="d-inline-block">
                                            <a
                                                href="javascript:void(0)"
                                                :style="{'pointer-events':salesmenTypesPagination.current_page == 1 ? 'none': ''}"
                                                @click.prevent="getData(salesmenTypesPagination.current_page - 1)"
                                            >
                                                <span>&lt;</span>
                                            </a>
                                            <input
                                            ...
                                            <a
                                                href="javascript:void(0)"
                                                :style="{'pointer-events':salesmenTypesPagination.last_page == salesmenTypesPagination.current_page ? 'none': ''}"
                                                @click.prevent="getData(salesmenTypesPagination.current_page + 1)"
                                            >
                                                <span>&gt;</span>
                                            </a>
                                ...
                                <tr>
                                        ...
                                        <div class="d-flex justify-content-center">
                                            ...
                                            <div class="arrow-sort">
                                                <i class="fas fa-arrow-up"
                                                   @click="salesmenTypes.sort(sortString('name'))"></i>
                                    ...
                                    <th>
                                        <div class="d-flex justify-content-center">
                                            ...
                                            <div class="arrow-sort">
                                                <i class="fas fa-arrow-up"
                                                   @click="salesmenTypes.sort(sortString('name_e'))"></i>
                                                <i class="fas fa-arrow-down"
                                                   @click="salesmenTypes.sort(sortString('-name_e'))"></i>
                                            </div>
                                        </div>
                                                    ...
                                                    <div class="col-md-6 mt-1">
                                                        <div class="form-group">
                                                            ...
                                                            <select
                                                                ...
                                                                :class="{
                                                                    'is-invalid':$v.edit.is_employee.$error || errors.is_employee,
                                                                    'is-valid':!$v.edit.is_employee.$invalid && !errors.is_employee
                                                                }"
                                                            >
