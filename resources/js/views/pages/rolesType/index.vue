...
export default {
    ...
    methods: {
        ...
        getData(page = 1) {
            ...
            adminApi.get(`/role_types?page=${page}&per_page=${this.per_page}&search=${this.search}`)
                .then((res) => {
                    let l = res.data;
        ...
        getDataCurrentPage() {
            if (this.current_page <= this.rolesTypePagination.last_page && this.current_page != this.rolesTypePagination.current_page && this.current_page) {
                ...
                adminApi.get(`/role_types?page=${this.current_page}&per_page=${this.per_page}&search=${this.search}`)
                    .then((res) => {
                        let l = res.data;
                        this.rolesType = l.data;
                        this.rolesTypePagination = l.pagination;
        ...
        editSubmit(id) {
            ...
            if (this.$v.edit.$invalid) {
                ...
                adminApi.put(`/role_types/${id}`, {name, name_e})
                    .then((res) => {
                                    ...
                                    <div class="d-inline-flex align-items-center pagination-custom">
                                        ...
                                        <div class="d-inline-block">
                                            <a
                                                ...
                                                :style="{'pointer-events':rolesTypePagination.current_page == 1 ? 'none': ''}"
                                            ...
                                            <a
                                                href="javascript:void(0)"
                                                :style="{'pointer-events':rolesTypePagination.last_page == rolesTypePagination.current_page ? 'none': ''}"
                                                @click.prevent="getData(rolesTypePagination.current_page + 1)"
                                            >
                                                <span>&gt;</span>
                                            </a>
                                ...
                                <tr>
                                        ...
                                        <div class="d-flex justify-content-center">
                                            ...
                                            <div class="arrow-sort">
                                                <i class="fas fa-arrow-up"
                                                   @click="rolesType.sort(sortString('name'))"></i>
                                    ...
                                    <th>
                                        <div class="d-flex justify-content-center">
                                            ...
                                            <div class="arrow-sort">
                                                <i class="fas fa-arrow-up"
                                                   @click="rolesType.sort(sortString('name_e'))"></i>
                                                <i class="fas fa-arrow-down"
                                                   @click="rolesType.sort(sortString('-name_e'))"></i>
                                            </div>
                                        </div>
