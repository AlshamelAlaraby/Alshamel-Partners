...
export default {
    page: {
        ...
        meta: [{name: "Installment Status", content: 'Installment Status'}],
    },
    mixins:[translation],
    components: {
        Layout,
    ...
    beforeRouteEnter(to, from, next) {
        next((vm) => {
            // if (vm.$store.state.auth.work_flow_trees.includes('color')) {
                return true;
            // } else {
    ...
    methods: {
            ...
            if (Array.isArray(id)) {
                Swal.fire({
                    ...
                    if (result.value) {
                        this.isLoader = true;
                        adminApi
                            .post(`/recievable-payable/rp_installment_status/bulk-delete`, { ids: id })
                            .then((res) => {
                                this.checkAll = [];
                                this.getData();
                                Swal.fire({
                ...
                Swal.fire({
                    ...
                    if (result.value) {
                        ...
                        adminApi
                            .delete(`/recievable-payable/rp_installment_status/${id}`)
                            .then((res) => {
                                this.checkAll = [];
                                this.getData();
                                Swal.fire({
        ...
        AddSubmit() {
            ...
            if (this.$v.create.$invalid) {
                ...
                this.isLoader = true;
                this.errors = {};
                adminApi.post(`/recievable-payable/rp_installment_status`, this.create)
                    .then((res) => {
        ...
        editSubmit(id) {
            ...
            if (this.$v.edit.$invalid) {
                ...
                adminApi.put(`/recievable-payable/rp_installment_status/${id}`, {name, name_e, is_default})
                    .then((res) => {
        ...
        log(id) {
            if(this.mouseEnter != id){
                ...
                this.mouseEnter = id;
                adminApi
                    .get(`/recievable-payable/rp_installment_status/logs/${id}`)
                    .then((res) => {
                        let l = res.data.data;
                        l.forEach((e) => {
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="row justify-content-between align-items-center mb-2">
                            <h4 class="header-title"> {{ $t('general.installmentStatusTable') }}</h4>
                                ...
                                <tr>
                                        ...
                                        <div class="d-flex justify-content-center">
                                            ...
                                            <div class="arrow-sort">
                                                <i class="fas fa-arrow-up"
                                                   @click="installmentStatus.sort(sortString('name'))"></i>
                                    ...
                                    <th v-if="setting.name_e">
                                        <div class="d-flex justify-content-center">
                                            ...
                                            <div class="arrow-sort">
                                                <i class="fas fa-arrow-up"
                                                   @click="installmentStatus.sort(sortString('name_e'))"></i>
                                                <i class="fas fa-arrow-down"
                                                   @click="installmentStatus.sort(sortString('-name_e'))"></i>
                                            </div>
                                        </div>
                                ...
                                >
                                    ...
                                    <td>
                                        ...
                                        <b-modal
                                            ...
                                            :title="getCompanyKey('installment_status_edit_form')"
                                            title-class="font-18"
                                            body-class="p-4"
                                            :ref="`edit-${data.id}`"
                                            :hide-footer="true"
