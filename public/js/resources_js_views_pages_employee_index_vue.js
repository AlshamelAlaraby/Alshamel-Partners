...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  beforeRouteEnter: function beforeRouteEnter(to, from, next) {
    next(function (vm) {
      if (vm.$store.state.auth.work_flow_trees.includes('employees')) {
        return true;
      } else {
  ...
  methods: {
    ...
    AddSubmit: function AddSubmit() {
      ...
      if (this.$v.create.$invalid) {
        ...
        this.isLoader = true;
        this.errors = {};
        _api_adminAxios__WEBPACK_IMPORTED_MODULE_2__["default"].post("/employees", this.create).then(function (res) {
...
var render = function render() {
  ...
  }, [_vm._v(_vm._s(_vm.getCompanyKey("employee_name_ar")))]), _vm._v(" "), _c("b-form-checkbox", {
    staticClass: "mb-1",
    attrs: {
      value: "name_e"
    },
  ...
  }, [_vm._v(_vm._s(_vm.getCompanyKey("employee_name_en")))])], 1)], 1), _vm._v(" "), _c("div", {
  ...
  })])])]), _vm._v(" "), _vm.employees.length > 0 ? _c("tbody", _vm._l(_vm.employees, function (data, index) {
    return _c("tr", {
      key: data.id,
