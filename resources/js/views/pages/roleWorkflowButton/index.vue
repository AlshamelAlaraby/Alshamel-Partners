...
export default {
    ...
    methods: {
        ...
        async getData(page = 1) {
            ...
            await adminApi.get(`/role-workflow-button?page=${page}&per_page=${this.per_page}&search=${this.search}&${filter}`)
                .then((res) => {
                    let l = res.data;
        ...
        getDataCurrentPage(page =1 ) {
            if (this.current_page <= this.roleWorkflowButtonsPagination.last_page && this.current_page != this.roleWorkflowButtonsPagination.current_page && this.current_page) {
                ...
                adminApi.get(`/role-workflow-button?page=${page}&per_page=${this.per_page}&search=${this.search}&${filter}`)
                    .then((res) => {
                        let l = res.data;
                        this.roleWorkflowButtons = l.data;
                        this.roleWorkflowButtonsPagination = l.pagination;
        ...
        deleteModule(id) {
            Swal.fire({
                ...
                if (result.value) {
                    ...
                    adminApi.delete(`/role-workflow-button/${id}`)
                        .then((res) => {
                            this.getData();
                            this.checkAll = [];
                            Swal.fire({
        ...
        AddSubmit() {
            ...
            if (this.$v.create.$invalid) {
                ...
                this.isLoader = true;
                this.errors = {};
                adminApi.post(`/role-workflow-button`, this.create)
                    .then((res) => {
        ...
        editSubmit(id) {
            ...
            if (this.$v.edit.$invalid) {
                ...
                adminApi.put(`/role-workflow-button/${id}`, this.edit)
                    .then((res) => {
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                                ...
                                <div class="d-fex">
                                    ...
                                    <div class="d-inline-flex align-items-center pagination-custom">
                                        <div class="d-inline-block" style="font-size:13px;">
                                            {{ roleWorkflowButtonsPagination.from }}-{{ roleWorkflowButtonsPagination.to }} /
                                            {{ roleWorkflowButtonsPagination.total }}
                                        </div>
                                        <div class="d-inline-block">
                                            <a
                                                href="javascript:void(0)"
                                                :style="{'pointer-events':roleWorkflowButtonsPagination.current_page == 1 ? 'none': ''}"
                                                @click.prevent="getData(roleWorkflowButtonsPagination.current_page - 1)"
                                            >
                                                <span>&lt;</span>
                                            </a>
                                            <input
                                            ...
                                            <a
                                                href="javascript:void(0)"
                                                :style="{'pointer-events':roleWorkflowButtonsPagination.last_page == roleWorkflowButtonsPagination.current_page ? 'none': ''}"
                                                @click.prevent="getData(roleWorkflowButtonsPagination.current_page + 1)"
                                            >
                                                <span>&gt;</span>
                                            </a>
                        ...
                        <b-modal
                            id="create"
                            :title="$t('general.addroleWorkflowButton')"
                            title-class="font-18"
                            body-class="p-4 "
                            :hide-footer="true"
                            @show="resetModal"
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <multiselect
                                                ...
                                                :custom-label="opt => $i18n.locale == 'ar' ? buttons.find(x => x.id == opt).name : buttons.find(x => x.id == opt).name_e">
                                            </multiselect>
                                            <template v-if="errors.button_id">
                                                <ErrorMessage v-for="(errorMessage,index) in errors.button_id" :key="index">{{ errorMessage }}</ErrorMessage>
                                            </template>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <table class="table table-borderless table-hover table-centered m-0">
                                ...
                                >
                                    ...
                                    <td v-if="setting.button_id">
                                        <h5 class="m-0 font-weight-normal">{{ buttons.length > 0  ?
                                            $i18n.locale == 'ar' ? buttons.find(x => x.id == data.button_id).name : buttons.find(x => x.id == data.button_id).name_e
                                            : ''
                                            }}</h5>
                                    </td>
                                    <td>
                                        ...
                                        <b-modal
                                            ...
                                            :title="$t('general.editroleWorkflowButton')"
                                            title-class="font-18"
                                            body-class="p-4"
                                            :ref="`edit-${data.id}`"
                                            :hide-footer="true"
