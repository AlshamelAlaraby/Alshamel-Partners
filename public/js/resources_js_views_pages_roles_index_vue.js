...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  methods: {
    ...
    getData: function getData() {
      ...
      this.isLoader = true;
      _api_adminAxios__WEBPACK_IMPORTED_MODULE_2__["default"].get("/roles?page=".concat(page, "&per_page=").concat(this.per_page, "&search=").concat(this.search)).then(function (res) {
        var l = res.data;
        _this3.roles = l.data;
        _this3.rolesPagination = l.pagination;
    ...
    getDataCurrentPage: function getDataCurrentPage() {
      ...
      if (this.current_page <= this.rolesPagination.last_page && this.current_page != this.rolesPagination.current_page && this.current_page) {
        this.isLoader = true;
        _api_adminAxios__WEBPACK_IMPORTED_MODULE_2__["default"].get("/roles?page=".concat(this.current_page, "&per_page=").concat(this.per_page, "&search=").concat(this.search)).then(function (res) {
          var l = res.data;
          _this4.roles = l.data;
    ...
    AddSubmit: function AddSubmit() {
      ...
      if (this.$v.create.$invalid) {
        ...
        this.isLoader = true;
        this.errors = {};
        _api_adminAxios__WEBPACK_IMPORTED_MODULE_2__["default"].post("/roles", this.create).then(function (res) {
    ...
    getParent: function getParent() {
      var _this10 = this;
      _api_adminAxios__WEBPACK_IMPORTED_MODULE_2__["default"].get("/roles?roletype_id=".concat(0)).then(function (res) {
    ...
    resetModalEdit: function resetModalEdit(id) {
      var module = this.roles.find(function (e) {
        return id == e.id;
      });
...
var render = function render() {
  ...
  return _c("Layout", [_c("PageHeader"), _vm._v(" "), _c("div", {
    ...
    return _c("tr", {
      ...
      staticClass: "m-0 font-weight-normal"
    }, [_vm._v(_vm._s(data.name_e))])]), _vm._v(" "), _c("td", [_c("div", {
      ...
      staticClass: "invalid-feedback"
    }, [_vm._v(_vm._s(_vm.$t("general.alphaArabic")) + "\n                                                        ")]) : _vm._e(), _vm._v(" "), !_vm.$v.edit.name.minLength ? _c("div", {
      staticClass: "invalid-feedback"
