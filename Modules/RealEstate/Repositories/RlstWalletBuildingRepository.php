...
use Modules\RealEstate\Entities\RlstWalletBuilding;

class RlstWalletBuildingRepository implements RlstWalletBuildingRepositoryInterface
{

    private $model;
    private $setting;

    public function __construct(RlstWalletBuilding $model, UserSettingScreen $setting)
    {
        $this->model = $model;
    ...
    public function create($request)
    {
        DB::transaction(function () use ($request) {
            ...
            cacheForget("RlstWalletBuilding");
        });
    }
