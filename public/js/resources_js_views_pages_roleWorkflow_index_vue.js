  ...
  methods: {
          ...
          while (1) {
            switch (_context2.prev = _context2.next) {
              case 0:
                ...
                _context2.next = 6;
                return _api_adminAxios__WEBPACK_IMPORTED_MODULE_2__["default"].get("/role-workflows?page=".concat(page, "&per_page=").concat(_this4.per_page, "&search=").concat(_this4.search, "&").concat(filter)).then(function (res) {
                  var l = res.data;
                  _this4.roleWorkflows = l.data;
                  _this4.roleWorkflowsPagination = l.pagination;
    ...
    AddSubmit: function AddSubmit() {
      ...
      if (this.$v.create.$invalid) {
        ...
        this.isLoader = true;
        this.errors = {};
        _api_adminAxios__WEBPACK_IMPORTED_MODULE_2__["default"].post("/role-workflows", this.create).then(function (res) {
    ...
    editSubmit: function editSubmit(id) {
      ...
      if (this.$v.edit.$invalid) {
        ...
        this.isLoader = true;
        this.errors = {};
        _api_adminAxios__WEBPACK_IMPORTED_MODULE_2__["default"].put("/role-workflows/".concat(id), this.edit).then(function (res) {
        ...
        return _regeneratorRuntime().wrap(function _callee5$(_context5) {
          while (1) {
            switch (_context5.prev = _context5.next) {
              ...
              case 4:
                module = _this12.roleWorkflows.find(function (e) {
                  return id == e.id;
                });
...
var render = function render() {
  ...
  })])])]), _vm._v(" "), _vm.roleWorkflows.length > 0 ? _c("tbody", _vm._l(_vm.roleWorkflows, function (data, index) {
    return _c("tr", {
      key: data.id,
