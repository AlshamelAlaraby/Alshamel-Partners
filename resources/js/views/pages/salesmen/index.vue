...
import salesManType from "../../../components/create/salesManType";
    ...
    methods: {
        ...
        AddSubmit() {
            ...
            if (this.$v.create.$invalid) {
                ...
                this.isLoader = true;
                this.errors = {};
                adminApi.post(`/salesmen`, this.create)
                    .then((res) => {
        ...
        editSubmit(id) {
            ...
            if (this.$v.edit.$invalid) {
                ...
                this.isLoader = true;
                this.errors = {};
                adminApi.put(`/salesmen/${id}`, this.edit)
                    .then((res) => {
        ...
        async getSaleMenType(){
            ...
            await adminApi.get(`/salesmen-types?is_empolyee=1`)
                .then((res) => {
                    let l = res.data.data;
                    l.unshift({ id: 0, name: "اضف رجل مبيعات", name_e: "Add Sales Man Type" });
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="row justify-content-between align-items-center mb-2">
                            <h4 class="header-title"> {{ $t('salesmen.Table') }}</h4>
                                ...
                                <div class="d-fex">
                                    ...
                                    <div class="d-inline-flex align-items-center pagination-custom">
                                        <div class="d-inline-block" style="font-size:13px;">
                                            {{ salesmensPagination.from }}-{{ salesmensPagination.to }} /
                                            {{ salesmensPagination.total }}
                                        </div>
                                        <div class="d-inline-block">
                                            <a
                                                href="javascript:void(0)"
                                                :style="{'pointer-events':salesmensPagination.current_page == 1 ? 'none': ''}"
                                                @click.prevent="getData(salesmensPagination.current_page - 1)"
                                            >
                                                <span>&lt;</span>
                                            </a>
                                            <input
                                            ...
                                            <a
                                                href="javascript:void(0)"
                                                :style="{'pointer-events':salesmensPagination.last_page == salesmensPagination.current_page ? 'none': ''}"
                                                @click.prevent="getData(salesmensPagination.current_page + 1)"
                                            >
                                                <span>&gt;</span>
                                            </a>
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <div v-if="$v.create.salesman_type_id.$error || errors.salesman_type_id"
                                                 class="text-danger"
                                            >
                                                {{ $t('general.fieldIsRequired') }}
                                            </div>
                                            <template v-if="errors.salesman_type_id">
                                                <ErrorMessage v-for="(errorMessage,index) in errors.salesman_type_id"
                        ...
                        <div class="table-responsive mb-3 custom-table-theme position-relative">
                            ...
                            <table class="table table-borderless table-hover table-centered m-0">
                                        ...
                                        <div class="d-flex justify-content-center">
                                            ...
                                            <div class="arrow-sort">
                                                <i class="fas fa-arrow-up"
                                                   @click="salesmens.sort(sortString('name'))"></i>
                                ...
                                >
                                    ...
                                    <td v-if="setting.salesman_type_id">{{ $i18n.locale == 'ar' ? data.salesmanType.name :  data.salesmanType.name_e }}</td>
                                    <td>
                                        <div class="btn-group">
                                            <button
                                                type="button"
                                                ...
                                                <div class="row">
                                                    <div class="col-md-12 ">
                                                        <div class="form-group">
                                                            ...
                                                            <div v-if="$v.edit.salesman_type_id.$error || errors.salesman_type_id"
                                                                 class="text-danger"
                                                            >
                                                                {{ $t('general.fieldIsRequired') }}
                                                            </div>
