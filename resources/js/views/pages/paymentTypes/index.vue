  ...
  mixins: [translation],
    ...
    methods: {
        ...
        getData(page = 1) {
            ...
            adminApi.get(`/payment-types?page=${page}&per_page=${this.per_page}&search=${this.search}&${filter}`)
                .then((res) => {
                    let l = res.data;
                    this.paymentTypes = l.data;
                    this.paymentTypesPagination = l.pagination;
      ...
      if (Array.isArray(id)) {
        Swal.fire({
          ...
          if (result.value) {
            this.isLoader = true;
            adminApi
              .post(`/payment-types/bulk-delete`, { ids: id })
              .then((res) => {
                this.checkAll = [];
                this.getData();
                Swal.fire({
        ...
        AddSubmit() {
            ...
            if (this.$v.create.$invalid) {
                ...
                this.isLoader = true;
                this.errors = {};
                adminApi.post(`/payment-types`, this.create)
                    .then((res) => {
        ...
        editSubmit(id) {
            ...
            if (this.$v.edit.$invalid) {
                ...
                adminApi.put(`/payment-types/${id}`, {name, name_e, is_default})
                    .then((res) => {
         ...
         */
        resetModalEdit(id) {
            let module = this.paymentTypes.find(e => id == e.id);
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="row justify-content-between align-items-center mb-2">
                            <h4 class="header-title"> {{ $t('general.payment-types-Table') }}</h4>
                                ...
                                <div class="d-fex">
                                    ...
                                    <div class="d-inline-flex align-items-center pagination-custom">
                                        <div class="d-inline-block" style="font-size:13px;">
                                            {{ paymentTypesPagination.from }}-{{ paymentTypesPagination.to }} /
                                            {{ paymentTypesPagination.total }}
                                        </div>
                                        <div class="d-inline-block">
                                            <a
                                                href="javascript:void(0)"
                                                :style="{'pointer-events':paymentTypesPagination.current_page == 1 ? 'none': ''}"
                                                @click.prevent="getData(paymentTypesPagination.current_page - 1)"
                                            >
                                                <span>&lt;</span>
                                            </a>
                                            <input
                                            ...
                                            <a
                                                href="javascript:void(0)"
                                                :style="{'pointer-events':paymentTypesPagination.last_page == paymentTypesPagination.current_page ? 'none': ''}"
                                                @click.prevent="getData(paymentTypesPagination.current_page + 1)"
                                            >
                                                <span>&gt;</span>
                                            </a>
                            ...
                            <table class="table table-borderless table-hover table-centered m-0">
                                ...
                                >
                                    ...
                                    <td v-if="setting.is_default">
                                        <span :class="[
                                           parseInt(data.is_default)  == true ?
                                            'text-success':
                                            'text-danger',
                                            'badge'
                                            ]"
                                        >
                                            {{ parseInt(data.is_default) == true ? `${$t('general.Yes')}` : `${$t('general.No')}` }}
                                        </span>
                                    </td>
                                    <td>
                                        <div class="btn-group">
