...
export default {
    ...
    watch: {
        ...
        isCheckAll(after,befour){
            if(after){
                this.financialYears.forEach(el => {
    ...
    methods: {
        ...
        getData(page = 1){
            ...
            adminApi.get(`/financial-years?page=${page}&per_page=${this.per_page}&search=${this.search}`)
                .then((res) => {
                    let l = res.data;
                    this.financialYears = l.data;
                    this.financialYearsPagination = l.pagination;
        ...
        getDataCurrentPage(){
            if(this.current_page <= this.financialYearsPagination.last_page && this.current_page != this.financialYearsPagination.current_page && this.current_page){
                ...
                adminApi.get(`/financial-years?page=${this.current_page}&per_page=${this.per_page}&search=${this.search}`)
                    .then((res) => {
                        let l = res.data;
                        this.financialYears = l.data;
                        this.financialYearsPagination = l.pagination;
        ...
        AddSubmit(){
            ...
            if (this.$v.create.$invalid) {
                ...
                adminApi.post(`/financial-years`,{name,name_e,start_date,end_date})
                    .then((res) => {
                        this.$bvModal.hide(`create`);
                        this.getData();
                        setTimeout(() => {
        ...
        editSubmit(id){
            ...
            if (this.$v.edit.$invalid) {
                ...
                this.isLoader = true;
                this.errors = {};
                let {name,name_e,start_date,end_date} = this.edit;
                adminApi.put(`/financial-years/${id}`,{name,name_e,start_date,end_date})
                    .then((res) => {
         ...
         */
        resetModalEdit(id){
            let financialYear = this.financialYears.find(e => id == e.id );
            ...
            this.edit.start_date = formatDateTime(financialYear.start_date);
            this.edit.end_date = formatDateTime(financialYear.end_date);
            this.errors = {};
        },
        /**
         *  hidden Modal (edit)
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="row justify-content-between align-items-center mb-2">
                            <h4 class="header-title"> {{ $t('financialYear.financialYearsTable') }}</h4>
                                ...
                                <div class="d-fex">
                                    ...
                                    <div class="d-inline-flex align-items-center pagination-custom">
                                        <div class="d-inline-block" style="font-size:13px;">
                                            {{ financialYearsPagination.from }}-{{ financialYearsPagination.to }} / {{ financialYearsPagination.total }}
                                        </div>
                                        <div class="d-inline-block">
                                            <a
                                                href="javascript:void(0)"
                                                :style="{'pointer-events':financialYearsPagination.current_page == 1 ? 'none': ''}"
                                                @click.prevent="getData(financialYearsPagination.current_page - 1)"
                                            >
                                                <span>&lt;</span>
                                            </a>
                                            <input
                                            ...
                                            <a
                                                href="javascript:void(0)"
                                                :style="{'pointer-events':financialYearsPagination.last_page == financialYearsPagination.current_page ? 'none': ''}"
                                                @click.prevent="getData(financialYearsPagination.current_page + 1)"
                                            >
                                                <span>&gt;</span>
                                            </a>
                        ...
                        <b-modal
                            id="create"
                            :title="$t('financialYear.addfinancialYear')"
                            title-class="font-18"
                            body-class="p-4 "
                            :hide-footer="true"
                            @show="resetModal"
                        ...
                        <div class="table-responsive mb-3 custom-table-theme position-relative">
                            ...
                            <table class="table table-borderless table-hover table-centered m-0">
                                    ...
                                    <th>
                                        <div class="d-flex justify-content-center">
                                            ...
                                            <div class="arrow-sort">
                                                <i class="fas fa-arrow-up" @click="financialYears.sort(sortString('name'))"></i>
                                                <i class="fas fa-arrow-down" @click="financialYears.sort(sortString('-name'))"></i>
                                            </div>
                                        </div>
                                    </th>
                                    <th>
                                        <div class="d-flex justify-content-center">
                                            ...
                                            <div class="arrow-sort">
                                                <i class="fas fa-arrow-up" @click="financialYears.sort(sortString('name_e'))"></i>
                                                <i class="fas fa-arrow-down" @click="financialYears.sort(sortString('-name_e'))"></i>
                                            </div>
                                        </div>
                                    </th>
                                    <th>
                                        <div class="d-flex justify-content-center">
                                            ...
                                            <div class="arrow-sort">
                                                <i class="fas fa-arrow-up" @click="financialYears.sort(SortDate('start_date'))"></i>
                                                <i class="fas fa-arrow-down" @click="financialYears.sort(SortDate('-start_date'))"></i>
                                            </div>
                                        </div>
                                    </th>
                                    <th>
                                        <div class="d-flex justify-content-center">
                                            ...
                                            <div class="arrow-sort">
                                                <i class="fas fa-arrow-up" @click="financialYears.sort(SortDate('end_date'))"></i>
                                                <i class="fas fa-arrow-down" @click="financialYears.sort(SortDate('-end_date'))"></i>
                                            </div>
                                        </div>
                                    </th>
                                    <th>
                                ...
                                <tbody v-if="financialYears.length > 0">
                                  <tr
                                      @click.capture="checkRow(data.id)"
                                      @dblclick.prevent="$bvModal.show(`modal-edit-${data.id}`)"
                                      v-for="(data,index) in financialYears"
                                      :key="data.id"
                                  ...
                                  <td>{{ formatDate(data.end_date) }}</td>
                                    <td>
                                          ...
                                          <b-modal
                                              ...
                                              :title="$t('financialYear.editfinancialYear')"
                                              title-class="font-18"
                                              body-class="p-4"
                                              :ref="`edit-${data.id}`"
                                              :hide-footer="true"
                                                      ...
                                                      <div class="col-md-12">
                                                          <div class="form-group">
                                                              ...
                                                              <date-picker
                                                                  ...
                                                                  type="datetime"
                                                                  @change="end_date"
                                                                  :default-value="edit.custom_date_end"
                                                                  confirm
                                                              ></date-picker>
