...
export default {
  ...
  methods: {
     ...
     */
    resetModalHidden() {
      this.create = { name: "", name_e: "", type: "" , is_reference: ""};
      this.$nextTick(() => {
        this.$v.$reset();
      });
      this.errors = {};
    ...
    editSubmit(id) {
      ...
      if (this.$v.edit.$invalid) {
        ...
        this.isLoader = true;
        this.errors = {};
        let { name, name_e, is_reference, type } = this.edit;
        adminApi
      ...
      <div class="col-12">
        <div class="card">
          <div class="card-body">
            ...
            <b-modal
              id="create"
              :title="$t('DocumentField.AddDocumentField')"
              title-class="font-18"
              body-class="p-4 "
              :hide-footer="true"
              size="lg"
                  ...
                  <div class="col-md-6">
                    <div class="form-group">
                      ...
                      >
                        ...
                        <option value="numeric">{{ $t("general.DocumentFieldNumeric") }}</option>
                        <option value="date">{{ $t("general.DocumentFieldDate") }}</option>
                        <option value="ddlb{}">{{ $t("general.DocumentFieldDdlb") }}</option>
                        <option value="lookup(Table)">{{ $t("general.DocumentFieldLookup") }}</option>
                      </select>
                ...
                <thead>
                  <tr>
                    ...
                    <th v-if="setting.is_reference">
                      <div class="d-flex justify-content-center">
                        <span>{{ $t("general.isReference") }}</span>
                        <div class="arrow-sort">
                          <i
                            class="fas fa-arrow-up"
                  ...
                  >
                    ...
                    <td>
                      ...
                      <b-modal
                        ...
                        :title="$t('DocumentField.EditDocumentField')"
                        title-class="font-18"
                        body-class="p-4"
                        size="lg"
                        :ref="`edit-${data.id}`"
                              ...
                              <div class="form-group">
                                ...
                                >
                                  ...
                                  <option value="numeric">
                                    {{ $t("general.DocumentFieldNumeric") }}
                                  </option>
                                  <option value="date" >
                                    {{ $t("general.DocumentFieldDate") }}
                                  </option>
                                  <option value="ddlb{}">
                                    {{ $t("general.DocumentFieldDdlb") }}
                                  </option>
                                  <option value="lookup(Table)">
                                    {{ $t("general.DocumentFieldLookup") }}
                                  </option>
                                </select>
