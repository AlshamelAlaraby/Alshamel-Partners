...
class RpDocumentPlanRepository implements RpDocumentPlanRepositoryInterface
{

    private $model;
    private $setting;

    public function __construct(RpDocumentPlan $model, UserSettingScreen $setting)
    {
        $this->model = $model;
