...
class RlstUnitRepository implements RlstUnitRepositoryInterface
{

    private $model;
    private $setting;

    public function __construct(RlstUnit $model, UserSettingScreen $setting)
    {
        $this->model = $model;
