  ...
  methods: {
    ...
    getData: function getData() {
      ...
      _api_adminAxios__WEBPACK_IMPORTED_MODULE_2__["default"].get("/role-workflow-button?page=".concat(page, "&per_page=").concat(this.per_page, "&search=").concat(this.search, "&").concat(filter)).then(function (res) {
        var l = res.data;
        _this3.roleWorkflowButtons = l.data;
        _this3.roleWorkflowButtonsPagination = l.pagination;
        ...
        return _regeneratorRuntime().wrap(function _callee3$(_context3) {
          while (1) {
            switch (_context3.prev = _context3.next) {
              ...
              case 4:
                module = _this11.roleWorkflowButtons.find(function (e) {
                  return id == e.id;
                });
                _this11.edit.workflow_id = module.workflow_id;
                _this11.edit.role_id = module.role.id;
                _this11.edit.button_id = module.button_id;
                _this11.errors = {};
              case 9:
              case "end":
                return _context3.stop();
...
var render = function render() {
  ...
  return _c("Layout", [_c("PageHeader"), _vm._v(" "), _c("Role", {
    ...
    attrs: {
      id: "create",
      title: _vm.$t("general.addroleWorkflowButton"),
      "title-class": "font-18",
      "body-class": "p-4 ",
      "hide-footer": true
    },
    ...
    staticClass: "my-1 mr-2"
  }, [_vm._v(_vm._s(_vm.$t("general.button")))]), _vm._v(" "), _c("multiselect", {
    attrs: {
    ...
    staticClass: "d-flex justify-content-center"
  }, [_c("span", [_vm._v(_vm._s(_vm.$t("general.workflow")))])])]) : _vm._e(), _vm._v(" "), _vm.setting.button_id ? _c("th", [_c("div", {
    staticClass: "d-flex justify-content-center"
  }, [_c("span", [_vm._v(_vm._s(_vm.$t("general.button")))])])]) : _vm._e(), _vm._v(" "), _c("th", [_vm._v("\n                                    " + _vm._s(_vm.$t("general.Action")) + "\n                                ")]), _vm._v(" "), _c("th", [_c("i", {
    ...
    return _c("tr", {
      ...
      staticClass: "m-0 font-weight-normal"
    }, [_vm._v(_vm._s(data.workflow_id))])]) : _vm._e(), _vm._v(" "), _c("td", [_c("div", {
