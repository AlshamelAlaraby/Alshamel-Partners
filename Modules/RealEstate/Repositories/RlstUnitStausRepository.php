...
class RlstUnitStausRepository implements RlstUnitStatusRepositoryInterface
{

    private $model;
    private $setting;

    public function __construct(RlstUnitStatus $model, UserSettingScreen $setting)
    {
        $this->model = $model;
    ...
    public function create($request)
    {
        DB::transaction(function () use ($request) {
            ...
            cacheForget("rlst_unit_statuses");
        });
    }
