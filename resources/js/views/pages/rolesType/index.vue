...
export default {
  page: {
    ...
    beforeRouteEnter(to, from, next) {
        next((vm) => {
            if (vm.$store.state.auth.work_flow_trees.includes('role Type')) {
                return true;
            } else {
  ...
  methods: {
    ...
    getData(page = 1) {
      ...
      adminApi
        .get(
          `/role_types?page=${page}&per_page=${this.per_page}&search=${this.search}&${filter}`
        )
        .then((res) => {
          let l = res.data;
          this.rolesType = l.data;
          this.rolesTypePagination = l.pagination;
    ...
    getDataCurrentPage(page = 1) {
      if (
        this.current_page <= this.rolesTypePagination.last_page &&
        this.current_page != this.rolesTypePagination.current_page &&
        this.current_page
      ) {
        this.isLoader = true;
        let filter = "";
      ...
      if (Array.isArray(id)) {
        Swal.fire({
          ...
          if (result.value) {
            this.isLoader = true;
            adminApi
              .post(`/role_types/bulk-delete`, { ids: id })
              .then((res) => {
                this.checkAll = [];
                this.getData();
                Swal.fire({
     ...
     */
    resetModalEdit(id) {
      let module = this.rolesType.find((e) => id == e.id);
        ...
        <div class="card">
          <div class="card-body">
            ...
            <div class="row justify-content-between align-items-center mb-2">
              <h4 class="header-title">{{ $t("rolesType.Table") }}</h4>
                ...
                <div class="d-fex">
                  ...
                  <div class="d-inline-flex align-items-center pagination-custom">
                    <div class="d-inline-block" style="font-size: 13px">
                      {{ rolesTypePagination.from }}-{{ rolesTypePagination.to }} /
                      {{ rolesTypePagination.total }}
                    </div>
                    <div class="d-inline-block">
                      <a
                        ...
                        :style="{
                          'pointer-events':
                            rolesTypePagination.current_page == 1 ? 'none' : '',
                        }"
                        @click.prevent="getData(rolesTypePagination.current_page - 1)"
                      >
                        <span>&lt;</span>
                      </a>
                      <input
                      ...
                      <a
                        ...
                        :style="{
                          'pointer-events':
                            rolesTypePagination.last_page ==
                            rolesTypePagination.current_page
                              ? 'none'
                              : '',
                        }"
                        @click.prevent="getData(rolesTypePagination.current_page + 1)"
                      ...
                      <div class="d-flex justify-content-center">
                        ...
                        <div class="arrow-sort">
                          <i
                            ...
                            @click="rolesType.sort(sortString('name'))"
                          ></i>
                          <i
                    ...
                    <th v-if="setting.name_e">
                      <div class="d-flex justify-content-center">
                        ...
                        <div class="arrow-sort">
                          <i
                            class="fas fa-arrow-up"
                            @click="rolesType.sort(sortString('name_e'))"
                          ></i>
                          <i
                            class="fas fa-arrow-down"
                            @click="rolesType.sort(sortString('-name_e'))"
                  ...
                  >
                    ...
                    <td>
                      ...
                      <b-modal
                        ...
                        :title="getCompanyKey('role_type_edit_form')"
                        title-class="font-18"
                        body-class="p-4"
                        :ref="`edit-${data.id}`"
                        :hide-footer="true"
