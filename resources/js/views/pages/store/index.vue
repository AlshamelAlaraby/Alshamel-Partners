...
export default {
    ...
    methods: {
        ...
        getData(page = 1){
            ...
            adminApi.get(`/stores?page=${page}&per_page=${this.per_page}&company_id=${this.company_id}&search=${this.search}&${filter}`)
                .then((res) => {
                    let l = res.data;
                    this.stores = l.data;
                    this.storesPagination = l.pagination;
        ...
        getDataCurrentPage(page = 1){
            if(this.current_page <= this.storesPagination.last_page && this.current_page != this.storesPagination.current_page && this.current_page){
                ...
                adminApi.get(`/stores?page=${this.current_page}&per_page=${this.per_page}&search=${this.search}&${filter}&company_id=${this.company_id}`)
                    .then((res) => {
                        let l = res.data;
                        this.stores = l.data;
                        this.storesPagination = l.pagination;
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="row justify-content-between align-items-center mb-2">
                            <h4 class="header-title"> {{ $t('store.storesTable') }}</h4>
                                ...
                                <div class="d-fex">
                                    ...
                                    <div class="d-inline-flex align-items-center pagination-custom">
                                        <div class="d-inline-block" style="font-size:13px;">
                                            {{ storesPagination.from }}-{{ storesPagination.to }} / {{ storesPagination.total }}
                                        </div>
                                        <div class="d-inline-block">
                                            <a
                                                href="javascript:void(0)"
                                                :style="{'pointer-events':storesPagination.current_page == 1 ? 'none': ''}"
                                                @click.prevent="getData(storesPagination.current_page - 1)"
                                            >
                                                <span>&lt;</span>
                                            </a>
                                            <input
                                            ...
                                            <a
                                                href="javascript:void(0)"
                                                :style="{'pointer-events':storesPagination.last_page == storesPagination.current_page ? 'none': ''}"
                                                @click.prevent="getData(storesPagination.current_page + 1)"
                                            >
                                                <span>&gt;</span>
                                            </a>
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group position-relative">
                                            ...
                                            <div v-if="$v.create.branch_id.$error || errors.branch_id"
                                                 class="text-danger"
                                            >
                                                {{ $t('general.fieldIsRequired') }}
                                            </div>
                                            <template v-if="errors.branch_id">
                                                <ErrorMessage v-for="(errorMessage,index) in errors.branch_id" :key="index">{{ errorMessage }}</ErrorMessage>
                                            </template>
                                        </div>
                                    </div>
                                    <div class="col-md-12" >
                                ...
                                <tr>
                                    ...
                                    <th v-if="setting.name">
                                        <div class="d-flex justify-content-center">
                                            ...
                                            <div class="arrow-sort">
                                                <i class="fas fa-arrow-up" @click="stores.sort(sortString('name'))"></i>
                                                <i class="fas fa-arrow-down" @click="stores.sort(sortString('-name'))"></i>
                                            </div>
                                        </div>
                                    </th>
                                    <th v-if="setting.name_e">
                                        <div class="d-flex justify-content-center">
                                            ...
                                            <div class="arrow-sort">
                                                <i class="fas fa-arrow-up" @click="stores.sort(sortString('name_e'))"></i>
                                                <i class="fas fa-arrow-down" @click="stores.sort(sortString('-name_e'))"></i>
                                            </div>
                                        </div>
                                    </th>
                                                ...
                                                <div class="row">
                                                    <div class="col-md-12">
                                                        <div class="form-group position-relative">
                                                            ...
                                                            <div v-if="$v.edit.branch_id.$error || errors.branch_id"
                                                                 class="text-danger"
                                                            >
                                                                {{ $t('general.fieldIsRequired') }}
                                                            </div>
