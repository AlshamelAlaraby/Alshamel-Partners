...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  data: function data() {
    return {
      ...
      checkAll: [],
      current_page: 1,
      setting: ['name', 'name_e', 'is_employee']
    };
  },
  validations: {
    create: {
  ...
  methods: {
    ...
    getData: function getData() {
      ...
      this.isLoader = true;
      _api_adminAxios__WEBPACK_IMPORTED_MODULE_2__["default"].get("/salesmen-types?page=".concat(page, "&per_page=").concat(this.per_page, "&search=").concat(this.search)).then(function (res) {
        var l = res.data;
        _this3.salesmenTypes = l.data;
        _this3.salesmenTypesPagination = l.pagination;
    ...
    getDataCurrentPage: function getDataCurrentPage() {
      ...
      if (this.current_page <= this.salesmenTypesPagination.last_page && this.current_page != this.salesmenTypesPagination.current_page && this.current_page) {
        this.isLoader = true;
        _api_adminAxios__WEBPACK_IMPORTED_MODULE_2__["default"].get("/salesmen-types?page=".concat(this.current_page, "&per_page=").concat(this.per_page, "&search=").concat(this.search)).then(function (res) {
          var l = res.data;
          _this4.salesmenTypes = l.data;
          _this4.salesmenTypesPagination = l.pagination;
    ...
    AddSubmit: function AddSubmit() {
      ...
      if (this.$v.create.$invalid) {
        ...
        this.isLoader = true;
        this.errors = {};
        _api_adminAxios__WEBPACK_IMPORTED_MODULE_2__["default"].post("/salesmen-types", this.create).then(function (res) {
...
var render = function render() {
  ...
  return _c("Layout", [_c("PageHeader"), _vm._v(" "), _c("div", {
    ...
    attrs: {
      id: "create",
      title: _vm.$t("salesmen-types.add"),
      "title-class": "font-18",
      "body-class": "p-4 ",
      "hide-footer": true
    },
    ...
    on: {
      ...
      change: function change($event) {
        ...
        _vm.$set(_vm.$v.create.is_employee, "$model", $event.target.multiple ? $$selectedVal : $$selectedVal[0]);
      }
    }
  }, [_c("option", {
    attrs: {
  ...
  }, [_vm._v(_vm._s(_vm.$t("general.No")))])]), _vm._v(" "), _vm.errors.is_employee ? _vm._l(_vm.errors.is_employee, function (errorMessage, index) {
    return _c("ErrorMessage", {
      key: index
    }, [_vm._v(_vm._s(errorMessage) + "\n                                            ")]);
  }) : _vm._e()], 2)])]), _vm._v(" "), _c("div", {
  ...
  })])])]), _vm._v(" "), _vm.salesmenTypes.length > 0 ? _c("tbody", _vm._l(_vm.salesmenTypes, function (data, index) {
    return _c("tr", {
      key: data.id,
      ...
      attrs: {
        ...
        title: _vm.$t("salesmen-types.edit"),
        "title-class": "font-18",
        "body-class": "p-4",
        "hide-footer": true
      },
      ...
      on: {
        change: function change($event) {
          ...
          _vm.$set(_vm.$v.edit.is_employee, "$model", $event.target.multiple ? $$selectedVal : $$selectedVal[0]);
        }
      }
    }, [_c("option", {
      attrs: {
    ...
    }, [_vm._v(_vm._s(_vm.$t("general.No")) + "\n                                                            ")])]), _vm._v(" "), _vm.errors.is_employee ? _vm._l(_vm.errors.is_employee, function (errorMessage, index) {
      return _c("ErrorMessage", {
        key: index
      }, [_vm._v(_vm._s(errorMessage) + "\n                                                            ")]);
    }) : _vm._e()], 2)])]), _vm._v(" "), _c("div", {
