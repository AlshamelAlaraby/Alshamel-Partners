  ...
  methods: {
    ...
    AddSubmit: function AddSubmit() {
      ...
      if (this.$v.create.$invalid) {
        ...
        this.errors = {};
        this.is_disabled = false;
        _api_adminAxios__WEBPACK_IMPORTED_MODULE_2__["default"].post("/banks", this.create).then(function (res) {
          _this9.getData();
        ...
        return _regeneratorRuntime().wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              ...
              case 2:
                bank = _this11.banks.find(function (e) {
                  return id == e.id;
                });
                _this11.edit.name = bank.name;
                _this11.edit.name_e = bank.name_e;
                _this11.edit.country_id = bank.country_id;
                _this11.edit.swift_code = bank.swift_code;
                _this11.errors = {};
              case 8:
              case "end":
                return _context.stop();
...
var render = function render() {
  ...
  }, [_vm._v(_vm._s(_vm.$t("general.SwiftCode")))])], 1)], 1), _vm._v(" "), _c("div", {
  ...
  })])])]) : _vm._e(), _vm._v(" "), _vm.setting.swift_code ? _c("th", [_c("div", {
    staticClass: "d-flex justify-content-center"
  }, [_c("span", [_vm._v(_vm._s(_vm.$t("general.SwiftCode")))]), _vm._v(" "), _c("div", {
    staticClass: "arrow-sort"
  }, [_c("i", {
    staticClass: "fas fa-arrow-up",
    on: {
  ...
  })])])]), _vm._v(" "), _vm.banks.length > 0 ? _c("tbody", _vm._l(_vm.banks, function (data, index) {
    return _c("tr", {
      key: data.id,
      ...
      staticClass: "m-0 font-weight-normal"
    }, [_vm._v(_vm._s(data.name_e))])]) : _vm._e(), _vm._v(" "), _vm.setting.country_id ? _c("td", [_c("h5", {
      staticClass: "m-0 font-weight-normal"
    }, [_vm._v("\n                      " + _vm._s(_vm.$i18n.locale == "ar" ? data.country.name : data.country.name_e) + "\n                    ")])]) : _vm._e(), _vm._v(" "), _vm.setting.swift_code ? _c("td", [_c("h5", {
      staticClass: "m-0 font-weight-normal"
    }, [_vm._v(_vm._s(data.swift_code))])]) : _vm._e(), _vm._v(" "), _c("td", [_c("div", {
