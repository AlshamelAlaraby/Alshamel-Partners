...
class RpInstallmentStatusRepository implements RpInstallmentStatusRepositoryInterface
{

    private $model;
    private $setting;

    public function __construct(RpInstallmentStatus $model, UserSettingScreen $setting)
    {
        $this->model = $model;
