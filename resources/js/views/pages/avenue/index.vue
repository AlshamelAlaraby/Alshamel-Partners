...
export default {
  ...
  methods: {
    ...
    getData(page = 1) {
      ...
      adminApi
        .get(`/avenues?page=${page}&per_page=${this.per_page}`)
        .then((res) => {
          let l = res.data;
          this.avenues = l.data;
    ...
    getDataCurrentPage(page = 1) {
      if (
        this.current_page <= this.avenuesPagination.last_page &&
        this.current_page != this.avenuesPagination.current_page &&
        this.current_page
      ) {
        this.isLoader = true;
        ...
        adminApi
          .get(
            `/avenues?page=${page}&per_page=${this.per_page}&search=${this.columns}&columns=${this.filterSetting}`
          )
          .then((res) => {
            let l = res.data;
            this.avenues = l.data;
                ...
                <div class="d-inline-block" style="width: 22.2%">
                  ...
                  >
                    ...
                    <b-form-checkbox
                      ...
                      value="city_id"
                      class="mb-1"
                      >{{ $t("general.city") }}</b-form-checkbox
                    >
                  </b-dropdown>
                  <!-- Basic dropdown -->
                </div>
                ...
                <div class="d-fex">
                  ...
                  <div class="d-inline-flex align-items-center pagination-custom">
                    <div class="d-inline-block" style="font-size: 13px">
                      {{ avenuesPagination.from }}-{{ avenuesPagination.to }} /
                      {{ avenuesPagination.total }}
                    </div>
                    <div class="d-inline-block">
                      <a
                        ...
                        :style="{
                          'pointer-events':
                            avenuesPagination.current_page == 1 ? 'none' : '',
                        }"
                      ...
                      <a
                        ...
                        :style="{
                          'pointer-events':
                            avenuesPagination.last_page == avenuesPagination.current_page
                              ? 'none'
                              : '',
                        }"
                        @click.prevent="getData(avenuesPagination.current_page + 1)"
                      ...
                      <div class="d-flex justify-content-center">
                        ...
                        <div class="arrow-sort">
                          <i
                            ...
                            @click="avenues.sort(sortString('name'))"
                          ></i>
                          <i
                    ...
                    <th>
                      <div class="d-flex justify-content-center">
                        ...
                        <div class="arrow-sort">
                          <i
                            class="fas fa-arrow-up"
                            @click="avenues.sort(sortString('name_e'))"
                          ></i>
                          <i
                            class="fas fa-arrow-down"
                            @click="avenues.sort(sortString('-name_e'))"
                    ...
                    <th>
                      <div class="d-flex justify-content-center">
                        ...
                        <div class="arrow-sort">
                          <i
                            class="fas fa-arrow-up"
                            @click="avenues.sort(SortNumber('country_id'))"
                          ></i>
                          <i
                            class="fas fa-arrow-down"
                            @click="avenues.sort(SortNumber('-country_id'))"
                    ...
                    <th>
                      <div class="d-flex justify-content-center">
                        ...
                        <div class="arrow-sort">
                          <i
                            class="fas fa-arrow-up"
                            @click="avenues.sort(SortNumber('governorate_id'))"
                          ></i>
                          <i
                            class="fas fa-arrow-down"
                            @click="avenues.sort(SortNumber('-governorate_id'))"
                    ...
                    <th>
                      <div class="d-flex justify-content-center">
                        ...
                        <div class="arrow-sort">
                          <i
                            class="fas fa-arrow-up"
                            @click="avenues.sort(SortNumber('city_id'))"
                          ></i>
                          <i
                            class="fas fa-arrow-down"
                            @click="avenues.sort(SortNumber('-city_id'))"
                          ...
                          <div class="row">
                            ...
                            <div class="col-md-6">
                              <div class="form-group position-relative">
                                ...
                                <multiselect
                                  @input="getCity(edit.country_id, edit.governorate_id)"
                                ...
                                <div
                                  v-if="
                                    $v.edit.governorate_id.$error || errors.governorate_id
                                  "
                                  class="text-danger"
                                >
                                  {{ $t("general.fieldIsRequired") }}
