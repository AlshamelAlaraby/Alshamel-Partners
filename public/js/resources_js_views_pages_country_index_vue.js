...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  validations: {
    create: {
      ...
      short_code: {
        required: vuelidate_lib_validators__WEBPACK_IMPORTED_MODULE_9__.required,
        alpha: vuelidate_lib_validators__WEBPACK_IMPORTED_MODULE_9__.alpha,
        minLength: (0,vuelidate_lib_validators__WEBPACK_IMPORTED_MODULE_9__.minLength)(1),
        maxLength: (0,vuelidate_lib_validators__WEBPACK_IMPORTED_MODULE_9__.maxLength)(10)
      },
      phone_key: {
        required: vuelidate_lib_validators__WEBPACK_IMPORTED_MODULE_9__.required,
    ...
    * */
      ...
      if (file) {
        ...
        if (!this.idDelete) {
          ...
          _api_adminAxios__WEBPACK_IMPORTED_MODULE_2__["default"].post("/media", formDate).then(function (res) {
            var old_media = [];
            _this11.images.forEach(function (e) {
            ...
            _api_adminAxios__WEBPACK_IMPORTED_MODULE_2__["default"].put("/countries/".concat(_this11.country_id), {
              old_media: old_media,
              'media': new_media
            }).then(function (res) {
              var _res$data$data$media;
              _this11.images = (_res$data$data$media = res.data.data.media) !== null && _res$data$data$media !== void 0 ? _res$data$data$media : [];
          ...
          sweetalert2__WEBPACK_IMPORTED_MODULE_4___default().fire({
            ...
            if (result.value) {
              ...
              _formDate.append('media[0]', _this11.media);
              _api_adminAxios__WEBPACK_IMPORTED_MODULE_2__["default"].post("/media", _formDate).then(function (res) {
                var old_media = [];
                _this11.images.forEach(function (e) {
                  return old_media.push(e.id);
                });
                old_media.splice(old_media.indexOf(_this11.idDelete), 1);
                var new_media = [];
                res.data.data.forEach(function (e) {
                  return new_media.push(e.id);
                });
                _api_adminAxios__WEBPACK_IMPORTED_MODULE_2__["default"].put("/countries/".concat(_this11.country_id), {
                  ...
                  _this11.images = (_res$data$data$media2 = res.data.data.media) !== null && _res$data$data$media2 !== void 0 ? _res$data$data$media2 : [];
                  if (_this11.images && _this11.images.length > 0) {
                    _this11.showPhoto = _this11.images[_this11.images.length - 1].webp;
                  } else {
                    _this11.showPhoto = './images/img-1.png';
    ...
    deleteImageCreate: function deleteImageCreate(id, index) {
      ...
      _api_adminAxios__WEBPACK_IMPORTED_MODULE_2__["default"].put("/countries/".concat(this.country_id), {
        ...
        _this12.countries[index] = res.data.data;
        _this12.images = (_res$data$data$media3 = res.data.data.media) !== null && _res$data$data$media3 !== void 0 ? _res$data$data$media3 : [];
