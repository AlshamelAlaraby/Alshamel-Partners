...
export default [{
    ...
    },
    {
        ...
        component: () =>
            import ('../views/pages/apps/calendar/index')
    },
    {
        path: '/apps/chat',
        name: 'chat',
    ...
    },
    {
        ...
        component: () =>
            import ('../views/pages/apps/companies')
    },
    {
        path: '/apps/tickets',
        name: 'tickets',
        ...
        component: () =>
            import ('../views/pages/apps/tickets')
    },
    {
        ...
        component: () =>
            import ('../views/pages/apps/file-manager')
    },
    {
        ...
        component: () =>
            import ('../views/pages/ecommerce/partners/index')
    },
    {
        ...
        component: () =>
            import ('../views/pages/ecommerce/orders/index')
    },
    {
    ...
    },
    {
        ...
        component: () =>
            import ('../views/pages/ecommerce/products/index')
    },
    {
        path: '/ecommerce/cart',
        name: 'cart',
    ...
    },
    {
        ...
        component: () =>
            import ('../views/pages/ecommerce/order-detail')
    },
    {
        ...
        component: () =>
            import ('../views/pages/ecommerce/product-create')
    },
    {
        ...
        component: () =>
            import ('../views/pages/ecommerce/products-grid')
    },
    {
        ...
        component: () =>
            import ('../views/pages/ecommerce/sellers')
    },
    {
        path: '/email/inbox',
        name: 'email-inbox',
    ...
    },
    {
        ...
        component: () =>
            import ('../views/pages/email/templates')
    },
    {
        path: '/task/list',
        name: 'task-list',
    ...
    },
    {
        ...
        component: () =>
            import ('../views/pages/task/detail')
    },
    {
        path: '/task/kanban',
        name: 'kanban-board',
        ...
        component: () =>
            import ('../views/pages/task/kanban/index')
    },
    {
        path: '/contacts/list',
        name: 'contacts-list',
    ...
    },
    {
        ...
        component: () =>
            import ('../views/pages/authi/login-1')
    },
    {
        ...
        component: () =>
            import ('../views/pages/authi/register-1')
    },
    {
        ...
        component: () =>
            import ('../views/pages/authi/recoverpwd')
    },
    {
        ...
        component: () =>
            import ('../views/pages/authi/lock-screen')
    },
    {
        ...
        component: () =>
            import ('../views/pages/authi/signin-signup')
    },
    {
        path: '/auth/logout-1',
        name: 'auth-logout-1',
        ...
        component: () =>
            import ('../views/pages/authi/logout-1')
    },
    {
        path: '/auth/login-2',
        name: 'auth-login-2',
        ...
        component: () =>
            import ('../views/pages/authi/login-2')
    },
    {
        ...
        component: () =>
            import ('../views/pages/authi/register-2')
    },
    {
        ...
        component: () =>
            import ('../views/pages/authi/recoverpwd-2')
    },
    {
        ...
        component: () =>
            import ('../views/pages/authi/lock-screen-2')
    },
    {
        ...
        component: () =>
            import ('../views/pages/authi/signin-signup-2')
    },
    {
        path: '/auth/logout-2',
        name: 'auth-logout-2',
        ...
        component: () =>
            import ('../views/pages/authi/logout-2')
    },
    {
        path: '/extras/starter',
        name: 'extras-starter',
        ...
        component: () =>
            import ('../views/pages/extras/starter')
    },
    {
        ...
        component: () =>
            import ('../views/pages/extras/timeline')
    },
    {
        path: '/extras/sitemap',
        name: 'extras-sitemap',
        ...
        component: () =>
            import ('../views/pages/extras/sitemap')
    },
    {
        path: '/extras/invoice',
        name: 'extras-invoice',
        ...
        component: () =>
            import ('../views/pages/extras/invoice')
    },
    {
        path: '/extras/faqs',
        name: 'extras-faqs',
        ...
        component: () =>
            import ('../views/pages/extras/faqs')
    },
    {
        ...
        component: () =>
            import ('../views/pages/extras/search-results')
    },
    {
        path: '/extras/pricing',
        name: 'extras-pricing',
        ...
        component: () =>
            import ('../views/pages/extras/pricing')
    },
    {
        ...
        component: () =>
            import ('../views/pages/extras/maintenance')
    },
    {
        ...
        component: () =>
            import ('../views/pages/extras/coming-soon')
    },
    {
        ...
        component: () =>
            import ('../views/pages/extras/lightbox')
    },
    {
        path: '/error/404',
        name: 'error-404',
    ...
    },
    {
        ...
        component: () =>
            import ('../views/pages/error/404-alt')
    },
    {
        path: '/ui/avatars',
        name: 'ui-avatars',
    ...
    },
    {
        ...
        component: () =>
            import ('../views/pages/ui/spinners')
    },
    {
    ...
    },
    {
        ...
        component: () =>
            import ('../views/pages/charts/chartjs')
    },
    {
        path: '/charts/c3',
        name: 'charts-c3',
    ...
    },
    {
        ...
        component: () =>
            import ('../views/pages/charts/knob')
    },
    {
        path: '/maps/google',
        name: 'maps-google',
