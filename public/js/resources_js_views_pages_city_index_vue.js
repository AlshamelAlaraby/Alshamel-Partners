      ...
      return _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
        ...
        return _regeneratorRuntime().wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                city = _this10.cities.find(function (e) {
                  return id == e.id;
                });
                _context.next = 3;
...
var render = function render() {
  ...
  return _c("Layout", [_c("PageHeader"), _vm._v(" "), _c("div", {
  ...
  }), _vm._v(" "), _vm.$v.create.governorate_id.$error || _vm.errors.country_id ? _c("div", {
    staticClass: "text-danger"
    ...
    return _c("tr", {
      ...
      staticClass: "m-0 font-weight-normal"
    }, [_vm._v(_vm._s(data.name_e))])]), _vm._v(" "), _c("td", [_vm._v(_vm._s(_vm.$i18n.locale == "ar" ? data.country.name : data.country.name_e))]), _vm._v(" "), _c("td", [_vm._v(_vm._s(_vm.$i18n.locale == "ar" ? data.governorate.name : data.governorate.name_e))]), _vm._v(" "), _c("td", [_c("span", {
